...
<xsl:stylesheet
  ...
  <xsl:variable name="packages.config">
    <xsl:value-of select="//wix:Component[wix:File/@Source = '$(var.WebPath)\packages.config']/@Id" />
  </xsl:variable>
  <xsl:variable name="web.config">
    <xsl:value-of select="//wix:Component[wix:File/@Source = '$(var.WebPath)\Web.config']/@Id" />
  </xsl:variable>
  <xsl:variable name="mainAssembly">
    <xsl:value-of select="//wix:Component[wix:File/@Source = '$(var.WebPath)\bin\eidss.webclient.dll']/@Id" />
  </xsl:variable>
  ...
  <xsl:template match="//wix:Component[wix:File/@Source = '$(var.WebPath)\packages.config']" />
  <xsl:template match="//wix:Component[wix:File/@Source = '$(var.WebPath)\Web.config']" />
  <xsl:template match="//wix:Component[wix:File/@Source = '$(var.WebPath)\bin\eidss.webclient.dll']" />
