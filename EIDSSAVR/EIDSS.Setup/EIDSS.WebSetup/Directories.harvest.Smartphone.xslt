...
<xsl:stylesheet
  ...
  <xsl:variable name="packages.config">
    <xsl:value-of select="//wix:Component[wix:File/@Source = '$(var.SmartphonePath)\packages.config']/@Id" />
  </xsl:variable>
  <xsl:variable name="web.config">
    <xsl:value-of select="//wix:Component[wix:File/@Source = '$(var.SmartphonePath)\Web.config']/@Id" />
  </xsl:variable>
  <xsl:variable name="mainAssembly">
    <xsl:value-of select="//wix:Component[wix:File/@Source = '$(var.SmartphonePath)\bin\eidss.smartphone.web.dll']/@Id" />
  </xsl:variable>
  ...
  <xsl:template match="//wix:Component[wix:File/@Source = '$(var.SmartphonePath)\packages.config']" />
  <xsl:template match="//wix:Component[wix:File/@Source = '$(var.SmartphonePath)\Web.config']" />
  <xsl:template match="//wix:Component[wix:File/@Source = '$(var.SmartphonePath)\bin\eidss.smartphone.web.dll']" />
