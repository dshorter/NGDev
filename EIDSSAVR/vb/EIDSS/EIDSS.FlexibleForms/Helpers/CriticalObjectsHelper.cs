...
namespace EIDSS.FlexibleForms.Helpers
{
    ...
    /// </summary>
    public class CriticalObjectsHelper
    {
        public Dictionary<long, CriticalObject> Parameters { get; set; }
        public Dictionary<long, CriticalObject> Sections { get; set; }

        /// <summary>
        /// 
        /// </summary>
        public CriticalObjectsHelper()
        {
