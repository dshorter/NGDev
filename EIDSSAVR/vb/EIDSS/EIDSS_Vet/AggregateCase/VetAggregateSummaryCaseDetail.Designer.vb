...
Partial Class VetAggregateSummaryCaseDetail
    ...
    Public Sub New()
        ...
        MenuItem1.Visible = eidss.model.Reports.BaseMenuReportRegistrator.IsPaperFormAllowed("VetAggregateCaseSummary")
    ...
    Private Sub InitializeComponent()
        ...
        Me.SuspendLayout()
        bv.common.Resources.BvResourceManagerChanger.GetResourceManager(GetType(VetAggregateSummaryCaseDetail), resources)
