...
Partial Class ActionDetail
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ActionDetail))
        ...
        Me.SuspendLayout()
        bv.common.Resources.BvResourceManagerChanger.GetResourceManager(GetType(ActionDetail), resources)
        ...
        'gvReference
        '
        Me.gvReference.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.gcolEnglishValue, Me.gcolTranslatedValue, Me.gcolActionCode, Me.gcolHACode, Me.gcolOrder})
        ...
        'lblRefType
        '
        resources.ApplyResources(Me.lblRefType, "lblRefType")
        ...
        Me.cbRefType.Properties.AutoHeight = CType(resources.GetObject("cbRefType.Properties.AutoHeight"), Boolean)
        ...
        Me.cbRefType.Properties.NullValuePrompt = resources.GetString("cbRefType.Properties.NullValuePrompt")
        ...
        Me.Controls.SetChildIndex(Me.lblRefType, 0)
