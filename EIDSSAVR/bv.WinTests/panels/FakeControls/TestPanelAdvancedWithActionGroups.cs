...
{
    public partial class TestPanelAdvancedWithActionGroups : TestPanelAdvancedUI
    {
        public TestPanelAdvancedWithActionGroups()
        {
            InitializeComponent();
        }
        ...
        public override ILayout GetLayout()
        {
            ...
            //return CurrentLayout ?? (CurrentLayout = this.CreateLayoutSimple(BusinessObject, "Test Advanced Layout", "F02", null));
        }
