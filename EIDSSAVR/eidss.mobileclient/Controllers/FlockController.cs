...
namespace eidss.mobileclient.Controllers
{
    ...
    public class FlockController : Controller
    {
        ...
        public ActionResult SpeciesDetails(long rootKey, string name, long? idfSpecies)
        {
            ...
            VetFarmTree species = VetFarmTreeProcessor.GetSpecies(Session.SessionID, rootKey, name, idfSpecies, HACode.Avian);
        ...
        public ActionResult SpeciesDetails(long rootKey, string name, bool isNew, string formData)
        {
            ...
            string errormsg;
            if (VetFarmTreeProcessor.UpdateSpecies(Session.SessionID, rootKey, name, isNew, form, HACode.Avian, out errormsg))
            {
