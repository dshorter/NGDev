...
namespace bv.tests.Schema
{
    ...
    public abstract partial class Lookup2ParamTable : 
        EditableObject<Lookup2ParamTable>
        , IObject
        , IDisposable
        , ILookupUsage
        {
        ...
        protected class field_info
        {
            ...
            internal Func<Lookup2ParamTable, object> _get_func;
            internal Action<Lookup2ParamTable, string> _set_func;
            internal Action<Lookup2ParamTable, Lookup2ParamTable, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        internal CompareModel _compare(IObject o, CompareModel ret)
        {
            ...
            Lookup2ParamTable obj = (Lookup2ParamTable)o;
        ...
        internal string m_ObjectName = "Lookup2ParamTable";
        ...
        {
            var ret = base.Clone() as Lookup2ParamTable;
            ret.bIsClone = true;
            ret.Cloned();
        ...
        public Lookup2ParamTable CloneWithSetup()
        {
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                return CloneWithSetup(manager) as Lookup2ParamTable;
            }
        }
        #endregion
        ...
        private bool IsRIRPropChanged(string fld, Lookup2ParamTable c)
        {
            return IsReadOnly(fld) != c.IsReadOnly(fld) || IsInvisible(fld) != c.IsInvisible(fld) || IsRequired(fld) != c._isRequired(m_isRequired, fld);
        }
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, Lookup2ParamTable c)
        {
        ...
        private void Lookup2ParamTable_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            (sender as Lookup2ParamTable).Changed(e.PropertyName);
        ...
        internal Dictionary<string, Func<Lookup2ParamTable, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<Lookup2ParamTable, bool>> isRequiredDict, string name)
        {
        ...
        public void AddRequired(string name, Func<Lookup2ParamTable, bool> func)
        {
            if (m_isRequired == null) 
                m_isRequired = new Dictionary<string, Func<Lookup2ParamTable, bool>>();
            if (!m_isRequired.ContainsKey(name))
                m_isRequired.Add(name, func);
        }
    
    internal Dictionary<string, Func<Lookup2ParamTable, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<Lookup2ParamTable, bool> func)
    {
      if (m_isHiddenPersonalData == null)
        m_isHiddenPersonalData = new Dictionary<string, Func<Lookup2ParamTable, bool>>();
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        : DataAccessor<Lookup2ParamTable>
            , IObjectAccessor
            , IObjectMeta
            , IObjectValidator
            
            , IObjectCreator
            , IObjectCreator<Lookup2ParamTable>
            
        {
            ...
            public delegate void on_action(Lookup2ParamTable obj);
            ...
            public virtual List<Lookup2ParamTable> SelectLookupList(DbManagerProxy manager
                , Int32? ParentID
                )
            {
            ...
            public virtual List<Lookup2ParamTable> SelectList(DbManagerProxy manager
                , Int32? ParentID
                )
            {
                return _SelectList(manager
                    , ParentID
                    , delegate(Lookup2ParamTable obj)
                        {
                        }
                    , delegate(Lookup2ParamTable obj)
                        {
            ...
            internal void _SetupLoad(DbManagerProxy manager, Lookup2ParamTable obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            internal void _SetPermitions(IObjectPermissions permissions, Lookup2ParamTable obj)
            {
                if (obj != null)
                {
            ...
            private Lookup2ParamTable _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                Lookup2ParamTable obj = null;
                try
                {
                    obj = Lookup2ParamTable.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public Lookup2ParamTable CreateNewT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            private void _SetupChildHandlers(Lookup2ParamTable obj, object newobj)
            {
                
            }
            
            private void _SetupHandlers(Lookup2ParamTable obj)
            {
                
            }
    

            internal void _LoadLookups(DbManagerProxy manager, Lookup2ParamTable obj)
            {
            ...
            protected ValidationModelException ChainsValidate(Lookup2ParamTable obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(Lookup2ParamTable obj, bool bRethrowException)
            {
            ...
            public bool Validate(DbManagerProxy manager, Lookup2ParamTable obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
            ...
            private void _SetupRequired(Lookup2ParamTable obj)
            {
            
            }
    
    private void _SetupPersonalDataRestrictions(Lookup2ParamTable obj)
    {
            ...
            public bool RequiredByField(string name, IObject obj) { return Meta.RequiredByField.ContainsKey(name) ? Meta.RequiredByField[name](obj as Lookup2ParamTable) : false; }
            ...
            public string DetailPanel { get { return "Lookup2ParamTableDetail"; } }
        ...
        {
            public static string spSelect = "spLookupTable2Param_SelectLookup";
            ...
            public static Dictionary<string, Func<Lookup2ParamTable, bool>> RequiredByField = new Dictionary<string, Func<Lookup2ParamTable, bool>>();
            public static Dictionary<string, Func<Lookup2ParamTable, bool>> RequiredByProperty = new Dictionary<string, Func<Lookup2ParamTable, bool>>();
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(ObjectAccessor.PostInterface<Lookup2ParamTable>().Post(manager, (Lookup2ParamTable)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(((Lookup2ParamTable)c).MarkToDelete() && ObjectAccessor.PostInterface<Lookup2ParamTable>().Post(manager, (Lookup2ParamTable)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
