...
(function($, undefined) {
    ...
    var calendar = {
        ...
        views: [{
            ...
            title: function(date, min, max, culture) {
                ...
                // BV end
                return getCalendarInfo(culture).months.names[date.getMonth()] + " " + (date.getFullYear() + shiftYear); // BV
            },
        ...
        },
        {
            ...
            title: function(date) {
                ...
                var shiftYear = (culture.name == "th-TH" || kendo.forceThaiDate) && !kendo.forceGrigDate ? 543 : 0;
                // BV end
                return date.getFullYear() + shiftYear; // BV
            },
            content: function(options) {
            ...
            content: function(options) {
                ...
                return view({
                    ...
                    build: function(date, idx) {
                        return {
                            value: date.getFullYear() + shiftYear, // BV
                            ns: kendo.ns,
                            dateString: toDateString(date),
        ...
        },
        {
            ...
            content: function(options) {
                ...
                var culture = kendo.getCulture("");
                var shiftYear = (culture.name == "th-TH" || kendo.forceThaiDate) && !kendo.forceGrigDate ? 543 : 0;
                var shiftDecade = (culture.name == "th-TH" || kendo.forceThaiDate) && !kendo.forceGrigDate ? 43 : 0;
                // BV end
                ...
                return view({
                    ...
                    build: function(date, idx) {
                        ...
                        return {
                            ns: kendo.ns,
                            value: (start + shiftYear) + " - " + (end + shiftYear), // BV
                            dateString: toDateString(date),
                            cssClass: idx === 0 || idx == 11 ? OTHERMONTHCLASS : ""
                        };
                    }
    ...
    function title(date, min, max, modular) {
        ...
        var culture = kendo.getCulture("");
        var shiftYear = (culture.name == "th-TH" || kendo.forceThaiDate) && !kendo.forceGrigDate ? 543 : 0;
        var shiftDecade = (culture.name == "th-TH" || kendo.forceThaiDate) && !kendo.forceGrigDate ? (modular == 10 ? 3 : 43) : 0;
        // BV end

        start = start - shiftDecade - start % modular; // BV
        end = start + (modular - 1);
