var gridFacade = (function () {
    ...
    function getOnRowButtons(gridId) {
        var buttonAdd = $("#" + gridId + " .k-grid-toolbar input[data-role='grid-add-button']");
        if (buttonAdd.length == 1 && buttonAdd.attr("disabled") == "disabled") {
            var buttons = $("#" + gridId + " .k-grid-toolbar input[data-role='grid-on-row-button'][data-disabled!='grid-on-row-button-disabled-on-readonly']");
            return buttons;
        } else {
    ...
    return {
        ...
        getEditButtons: function (gridId) {
            var buttons = $("#" + gridId + " .k-grid-content table tbody tr td.editColumn a.editButton");
            return buttons;
        },

        getDeleteButtons: function (gridId) {
            var buttons = $("#" + gridId + " .k-grid-content table tbody tr td.editColumn a.deleteButton");
            return buttons;
        },
        ...
        disableToolbarButtons: function (gridId) {
            ...
            var buttonsEdit = gridFacade.getEditButtons(gridId);
            gridFacade.hideButtons(buttonsEdit);
            var buttonsDelete = gridFacade.getDeleteButtons(gridId);
            gridFacade.hideButtons(buttonsDelete);
        },
        ...
        enableToolbarButtons: function (gridId) {
            ...
            var buttonsEdit = gridFacade.getEditButtons(gridId);
            gridFacade.showButtons(buttonsEdit);
            var buttonsDelete = gridFacade.getDeleteButtons(gridId);
            gridFacade.showButtons(buttonsDelete);
        },
        ...
        enableOnRowButtons: function (gridId) {
            ...
            /*var buttonAdd = $("#" + gridId + " .k-grid-toolbar input[data-role='grid-add-button']");
            if (buttonAdd.length == 1 && buttonAdd.attr("disabled") == "disabled") {
                var buttonsToDisable = $("#" + gridId + " .k-grid-toolbar input[data-role='grid-on-row-button'][data-disabled='grid-on-row-button-disabled-on-readonly']");
                gridFacade.disableButtons(buttonsToDisable);
            }*/
        },
