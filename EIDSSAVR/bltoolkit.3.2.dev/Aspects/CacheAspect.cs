...
namespace BLToolkit.Aspects
{
	...
	public class CacheAspect : Interceptor
	{
        ...
        // BVChanges: adding _object field
        ...
        // BVChanges: ClearAllCache begin
        public static void ClearAllCache(MethodInfo methodInfo)
        {
            if (methodInfo == null)
                throw new ArgumentNullException("methodInfo");
        ...
        // BVChanges: adding ClearCache
        public static void ClearCache(Type declaringType, object accessor)
        {
            if (declaringType == null)
                throw new ArgumentNullException("declaringType");
