...
namespace hmis2eidss.service.Schema
{
    ...
    public abstract partial class HmisRayonLookup : 
        EditableObject<HmisRayonLookup>
        , IObject
        , IDisposable
        , ILookupUsage
        {
        ...
        [LocalizedDisplayName(_str_strHmisRayon)]
        [MapField(_str_strHmisRayon)]
        public abstract String strHmisRayon { get; set; }
        protected String strHmisRayon_Original { get { return ((EditableValue<String>)((dynamic)this)._strHmisRayon).OriginalValue; } }
        protected String strHmisRayon_Previous { get { return ((EditableValue<String>)((dynamic)this)._strHmisRayon).PreviousValue; } }
        ...
        protected class field_info
        {
            ...
            internal Func<HmisRayonLookup, object> _get_func;
            internal Action<HmisRayonLookup, string> _set_func;
            internal Action<HmisRayonLookup, HmisRayonLookup, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        internal const string _str_strHmisRayon = "strHmisRayon";
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_strHmisRayon, _formname = _str_strHmisRayon, _type = "String",
              _get_func = o => o.strHmisRayon,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseString(val); if (o.strHmisRayon != newval) o.strHmisRayon = newval; },
              _compare_func = (o, c, m, g) => {
                if (o.strHmisRayon != c.strHmisRayon || o.IsRIRPropChanged(_str_strHmisRayon, c)) 
                  m.Add(_str_strHmisRayon, o.ObjectIdent + _str_strHmisRayon, o.ObjectIdent2 + _str_strHmisRayon, o.ObjectIdent3 + _str_strHmisRayon, "String", 
                    o.strHmisRayon == null ? "" : o.strHmisRayon.ToString(),                  
                  o.IsReadOnly(_str_strHmisRayon), o.IsInvisible(_str_strHmisRayon), o.IsRequired(_str_strHmisRayon)); 
                  }
              }, 
        ...
        internal CompareModel _compare(IObject o, CompareModel ret)
        {
            ...
            HmisRayonLookup obj = (HmisRayonLookup)o;
        ...
        internal string m_ObjectName = "HmisRayonLookup";
        ...
        {
            var ret = base.Clone() as HmisRayonLookup;
            ret.bIsClone = true;
            ret.Cloned();
        ...
        public HmisRayonLookup CloneWithSetup()
        {
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                return CloneWithSetup(manager) as HmisRayonLookup;
            }
        }
        #endregion
        ...
        private bool IsRIRPropChanged(string fld, HmisRayonLookup c)
        {
            return IsReadOnly(fld) != c.IsReadOnly(fld) || IsInvisible(fld) != c.IsInvisible(fld) || IsRequired(fld) != c._isRequired(m_isRequired, fld);
        }
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, HmisRayonLookup c)
        {
        ...
        {
            return new Func<HmisRayonLookup, string>(c => c.strRayonName)(this);
        }
        

        public HmisRayonLookup()
        {
        ...
        {
            PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(HmisRayonLookup_PropertyChanged);
        }
        public void _RevokeMainHandler()
        {
            PropertyChanged -= new System.ComponentModel.PropertyChangedEventHandler(HmisRayonLookup_PropertyChanged);
        }
        private void HmisRayonLookup_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            (sender as HmisRayonLookup).Changed(e.PropertyName);
        ...
        internal Dictionary<string, Func<HmisRayonLookup, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<HmisRayonLookup, bool>> isRequiredDict, string name)
        {
        ...
        public void AddRequired(string name, Func<HmisRayonLookup, bool> func)
        {
            if (m_isRequired == null) 
                m_isRequired = new Dictionary<string, Func<HmisRayonLookup, bool>>();
            if (!m_isRequired.ContainsKey(name))
                m_isRequired.Add(name, func);
        }
    
    internal Dictionary<string, Func<HmisRayonLookup, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<HmisRayonLookup, bool> func)
    {
      if (m_isHiddenPersonalData == null)
        m_isHiddenPersonalData = new Dictionary<string, Func<HmisRayonLookup, bool>>();
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        : DataAccessor<HmisRayonLookup>
            , IObjectAccessor
            , IObjectMeta
            , IObjectValidator
            
            , IObjectCreator
            , IObjectCreator<HmisRayonLookup>
            
        {
            ...
            public delegate void on_action(HmisRayonLookup obj);
            ...
            public virtual List<HmisRayonLookup> SelectLookupList(DbManagerProxy manager
                , Int64? RegionID
                )
            {
            ...
            public virtual List<HmisRayonLookup> SelectList(DbManagerProxy manager
                , Int64? RegionID
                )
            {
                return _SelectList(manager
                    , RegionID
                    , delegate(HmisRayonLookup obj)
                        {
                        }
                    , delegate(HmisRayonLookup obj)
                        {
            ...
            public List<HmisRayonLookup> _SelectList(DbManagerProxy manager
                , Int64? RegionID
            ...
            public virtual List<HmisRayonLookup> _SelectListInternal(DbManagerProxy manager
                , Int64? RegionID
                , on_action loading, on_action loaded
                )
            {
                HmisRayonLookup _obj = null;
                try
                {
                    MapResultSet[] sets = new MapResultSet[1];
                    List<HmisRayonLookup> objs = new List<HmisRayonLookup>();
                    sets[0] = new MapResultSet(typeof(HmisRayonLookup), objs);
                    
                    manager
                        .SetSpCommand("hmisRayon_SelectLookup"
            ...
            internal void _SetupLoad(DbManagerProxy manager, HmisRayonLookup obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            internal void _SetPermitions(IObjectPermissions permissions, HmisRayonLookup obj)
            {
                if (obj != null)
                {
            ...
            private HmisRayonLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                HmisRayonLookup obj = null;
                try
                {
                    obj = HmisRayonLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public HmisRayonLookup CreateNewT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public HmisRayonLookup CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public HmisRayonLookup CreateWithParamsT(DbManagerProxy manager, IObject Parent, List<object> pars)
            {
            ...
            private void _SetupChildHandlers(HmisRayonLookup obj, object newobj)
            {
                
            }
            
            private void _SetupHandlers(HmisRayonLookup obj)
            {
                
            }
    

            internal void _LoadLookups(DbManagerProxy manager, HmisRayonLookup obj)
            {
            ...
            protected ValidationModelException ChainsValidate(HmisRayonLookup obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(HmisRayonLookup obj, bool bRethrowException)
            {
            ...
            {
                return Validate(manager, obj as HmisRayonLookup, bPostValidation, bChangeValidation, bDeepValidation, bRethrowException);
            }
            public bool Validate(DbManagerProxy manager, HmisRayonLookup obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
            ...
            private void _SetupRequired(HmisRayonLookup obj)
            {
            
            }
    
    private void _SetupPersonalDataRestrictions(HmisRayonLookup obj)
    {
            ...
            public bool RequiredByField(string name, IObject obj) { return Meta.RequiredByField.ContainsKey(name) ? Meta.RequiredByField[name](obj as HmisRayonLookup) : false; }
            public bool RequiredByProperty(string name, IObject obj) { return Meta.RequiredByProperty.ContainsKey(name) ? Meta.RequiredByProperty[name](obj as HmisRayonLookup) : false; }
            public List<SearchPanelMetaItem> SearchPanelMeta { get { return Meta.SearchPanelMeta; } }
            public List<GridMetaItem> GridMeta { get { return Meta.GridMeta; } }
            public List<ActionMetaItem> Actions { get { return Meta.Actions; } }
            public string DetailPanel { get { return "HmisRayonLookupDetail"; } }
        ...
        {
            public static string spSelect = "hmisRayon_SelectLookup";
            ...
            public static Dictionary<string, Func<HmisRayonLookup, bool>> RequiredByField = new Dictionary<string, Func<HmisRayonLookup, bool>>();
            public static Dictionary<string, Func<HmisRayonLookup, bool>> RequiredByProperty = new Dictionary<string, Func<HmisRayonLookup, bool>>();
    ...
    private static void AddHiddenPersonalData(string name, Func<bool> func)
    {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Sizes.Add(_str_strHmisRayon, 36);
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(ObjectAccessor.PostInterface<HmisRayonLookup>().Post(manager, (HmisRayonLookup)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(((HmisRayonLookup)c).MarkToDelete() && ObjectAccessor.PostInterface<HmisRayonLookup>().Post(manager, (HmisRayonLookup)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
