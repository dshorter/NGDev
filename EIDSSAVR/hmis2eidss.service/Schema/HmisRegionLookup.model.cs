...
namespace hmis2eidss.service.Schema
{
    ...
    public abstract partial class HmisRegionLookup : 
        EditableObject<HmisRegionLookup>
        , IObject
        , IDisposable
        , ILookupUsage
        {
        ...
        [LocalizedDisplayName(_str_strHmisRegion)]
        [MapField(_str_strHmisRegion)]
        public abstract String strHmisRegion { get; set; }
        protected String strHmisRegion_Original { get { return ((EditableValue<String>)((dynamic)this)._strHmisRegion).OriginalValue; } }
        protected String strHmisRegion_Previous { get { return ((EditableValue<String>)((dynamic)this)._strHmisRegion).PreviousValue; } }
        ...
        protected class field_info
        {
            ...
            internal Func<HmisRegionLookup, object> _get_func;
            internal Action<HmisRegionLookup, string> _set_func;
            internal Action<HmisRegionLookup, HmisRegionLookup, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        internal const string _str_strHmisRegion = "strHmisRegion";
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_strHmisRegion, _formname = _str_strHmisRegion, _type = "String",
              _get_func = o => o.strHmisRegion,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseString(val); if (o.strHmisRegion != newval) o.strHmisRegion = newval; },
              _compare_func = (o, c, m, g) => {
                if (o.strHmisRegion != c.strHmisRegion || o.IsRIRPropChanged(_str_strHmisRegion, c)) 
                  m.Add(_str_strHmisRegion, o.ObjectIdent + _str_strHmisRegion, o.ObjectIdent2 + _str_strHmisRegion, o.ObjectIdent3 + _str_strHmisRegion, "String", 
                    o.strHmisRegion == null ? "" : o.strHmisRegion.ToString(),                  
                  o.IsReadOnly(_str_strHmisRegion), o.IsInvisible(_str_strHmisRegion), o.IsRequired(_str_strHmisRegion)); 
                  }
              }, 
        ...
        internal CompareModel _compare(IObject o, CompareModel ret)
        {
            ...
            HmisRegionLookup obj = (HmisRegionLookup)o;
        ...
        internal string m_ObjectName = "HmisRegionLookup";
        ...
        {
            var ret = base.Clone() as HmisRegionLookup;
            ret.bIsClone = true;
            ret.Cloned();
        ...
        public HmisRegionLookup CloneWithSetup()
        {
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                return CloneWithSetup(manager) as HmisRegionLookup;
            }
        }
        #endregion
        ...
        private bool IsRIRPropChanged(string fld, HmisRegionLookup c)
        {
            return IsReadOnly(fld) != c.IsReadOnly(fld) || IsInvisible(fld) != c.IsInvisible(fld) || IsRequired(fld) != c._isRequired(m_isRequired, fld);
        }
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, HmisRegionLookup c)
        {
        ...
        {
            return new Func<HmisRegionLookup, string>(c => c.strRegionName)(this);
        }
        

        public HmisRegionLookup()
        {
        ...
        {
            PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(HmisRegionLookup_PropertyChanged);
        }
        public void _RevokeMainHandler()
        {
            PropertyChanged -= new System.ComponentModel.PropertyChangedEventHandler(HmisRegionLookup_PropertyChanged);
        }
        private void HmisRegionLookup_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            (sender as HmisRegionLookup).Changed(e.PropertyName);
        ...
        internal Dictionary<string, Func<HmisRegionLookup, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<HmisRegionLookup, bool>> isRequiredDict, string name)
        {
        ...
        public void AddRequired(string name, Func<HmisRegionLookup, bool> func)
        {
            if (m_isRequired == null) 
                m_isRequired = new Dictionary<string, Func<HmisRegionLookup, bool>>();
            if (!m_isRequired.ContainsKey(name))
                m_isRequired.Add(name, func);
        }
    
    internal Dictionary<string, Func<HmisRegionLookup, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<HmisRegionLookup, bool> func)
    {
      if (m_isHiddenPersonalData == null)
        m_isHiddenPersonalData = new Dictionary<string, Func<HmisRegionLookup, bool>>();
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        : DataAccessor<HmisRegionLookup>
            , IObjectAccessor
            , IObjectMeta
            , IObjectValidator
            
            , IObjectCreator
            , IObjectCreator<HmisRegionLookup>
            
        {
            ...
            public delegate void on_action(HmisRegionLookup obj);
            ...
            public virtual List<HmisRegionLookup> SelectLookupList(DbManagerProxy manager
                , Int64? CountryID
                )
            {
            ...
            public virtual List<HmisRegionLookup> SelectList(DbManagerProxy manager
                , Int64? CountryID
                )
            {
                return _SelectList(manager
                    , CountryID
                    , delegate(HmisRegionLookup obj)
                        {
                        }
                    , delegate(HmisRegionLookup obj)
                        {
            ...
            public List<HmisRegionLookup> _SelectList(DbManagerProxy manager
                , Int64? CountryID
            ...
            public virtual List<HmisRegionLookup> _SelectListInternal(DbManagerProxy manager
                , Int64? CountryID
                , on_action loading, on_action loaded
                )
            {
                HmisRegionLookup _obj = null;
                try
                {
                    MapResultSet[] sets = new MapResultSet[1];
                    List<HmisRegionLookup> objs = new List<HmisRegionLookup>();
                    sets[0] = new MapResultSet(typeof(HmisRegionLookup), objs);
                    
                    manager
                        .SetSpCommand("hmisRegion_SelectLookup"
            ...
            internal void _SetupLoad(DbManagerProxy manager, HmisRegionLookup obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            internal void _SetPermitions(IObjectPermissions permissions, HmisRegionLookup obj)
            {
                if (obj != null)
                {
            ...
            private HmisRegionLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                HmisRegionLookup obj = null;
                try
                {
                    obj = HmisRegionLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public HmisRegionLookup CreateNewT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public HmisRegionLookup CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public HmisRegionLookup CreateWithParamsT(DbManagerProxy manager, IObject Parent, List<object> pars)
            {
            ...
            private void _SetupChildHandlers(HmisRegionLookup obj, object newobj)
            {
                
            }
            
            private void _SetupHandlers(HmisRegionLookup obj)
            {
                
            }
    

            internal void _LoadLookups(DbManagerProxy manager, HmisRegionLookup obj)
            {
            ...
            protected ValidationModelException ChainsValidate(HmisRegionLookup obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(HmisRegionLookup obj, bool bRethrowException)
            {
            ...
            {
                return Validate(manager, obj as HmisRegionLookup, bPostValidation, bChangeValidation, bDeepValidation, bRethrowException);
            }
            public bool Validate(DbManagerProxy manager, HmisRegionLookup obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
            ...
            private void _SetupRequired(HmisRegionLookup obj)
            {
            
            }
    
    private void _SetupPersonalDataRestrictions(HmisRegionLookup obj)
    {
            ...
            public bool RequiredByField(string name, IObject obj) { return Meta.RequiredByField.ContainsKey(name) ? Meta.RequiredByField[name](obj as HmisRegionLookup) : false; }
            public bool RequiredByProperty(string name, IObject obj) { return Meta.RequiredByProperty.ContainsKey(name) ? Meta.RequiredByProperty[name](obj as HmisRegionLookup) : false; }
            public List<SearchPanelMetaItem> SearchPanelMeta { get { return Meta.SearchPanelMeta; } }
            public List<GridMetaItem> GridMeta { get { return Meta.GridMeta; } }
            public List<ActionMetaItem> Actions { get { return Meta.Actions; } }
            public string DetailPanel { get { return "HmisRegionLookupDetail"; } }
        ...
        {
            public static string spSelect = "hmisRegion_SelectLookup";
            ...
            public static Dictionary<string, Func<HmisRegionLookup, bool>> RequiredByField = new Dictionary<string, Func<HmisRegionLookup, bool>>();
            public static Dictionary<string, Func<HmisRegionLookup, bool>> RequiredByProperty = new Dictionary<string, Func<HmisRegionLookup, bool>>();
    ...
    private static void AddHiddenPersonalData(string name, Func<bool> func)
    {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Sizes.Add(_str_strHmisRegion, 36);
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(ObjectAccessor.PostInterface<HmisRegionLookup>().Post(manager, (HmisRegionLookup)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(((HmisRegionLookup)c).MarkToDelete() && ObjectAccessor.PostInterface<HmisRegionLookup>().Post(manager, (HmisRegionLookup)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
