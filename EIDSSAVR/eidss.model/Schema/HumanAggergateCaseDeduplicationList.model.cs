...
namespace eidss.model.Schema
{
    ...
    public abstract partial class HumanAggregateCaseDeduplicationListItem : 
        EditableObject<HumanAggregateCaseDeduplicationListItem>
        , IObject
        , IDisposable
        , ILookupUsage
        {
        ...
        protected class field_info
        {
            ...
            internal Func<HumanAggregateCaseDeduplicationListItem, object> _get_func;
            internal Action<HumanAggregateCaseDeduplicationListItem, string> _set_func;
            internal Action<HumanAggregateCaseDeduplicationListItem, HumanAggregateCaseDeduplicationListItem, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        internal CompareModel _compare(IObject o, CompareModel ret)
        {
            ...
            HumanAggregateCaseDeduplicationListItem obj = (HumanAggregateCaseDeduplicationListItem)o;
        ...
        internal string m_ObjectName = "HumanAggregateCaseDeduplicationListItem";
        ...
        {
            var ret = base.Clone() as HumanAggregateCaseDeduplicationListItem;
            ret.bIsClone = true;
            ret.Cloned();
        ...
        public HumanAggregateCaseDeduplicationListItem CloneWithSetup()
        {
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                return CloneWithSetup(manager) as HumanAggregateCaseDeduplicationListItem;
            }
        }
        #endregion
        ...
        private bool IsRIRPropChanged(string fld, HumanAggregateCaseDeduplicationListItem c)
        {
            return IsReadOnly(fld) != c.IsReadOnly(fld) || IsInvisible(fld) != c.IsInvisible(fld) || IsRequired(fld) != c._isRequired(m_isRequired, fld);
        }
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, HumanAggregateCaseDeduplicationListItem c)
        {
        ...
        public HumanAggregateCaseDeduplicationListItem()
        {
        ...
        {
            PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(HumanAggregateCaseDeduplicationListItem_PropertyChanged);
        }
        public void _RevokeMainHandler()
        {
            PropertyChanged -= new System.ComponentModel.PropertyChangedEventHandler(HumanAggregateCaseDeduplicationListItem_PropertyChanged);
        }
        private void HumanAggregateCaseDeduplicationListItem_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            (sender as HumanAggregateCaseDeduplicationListItem).Changed(e.PropertyName);
        ...
        {
            HumanAggregateCaseDeduplicationListItem obj = this;
        ...
        private bool _isReadOnly(string name)
        {
            ...
            return ReadOnly || new Func<HumanAggregateCaseDeduplicationListItem, bool>(c => false)(this);
        ...
        internal Dictionary<string, Func<HumanAggregateCaseDeduplicationListItem, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<HumanAggregateCaseDeduplicationListItem, bool>> isRequiredDict, string name)
        {
        ...
        public void AddRequired(string name, Func<HumanAggregateCaseDeduplicationListItem, bool> func)
        {
            if (m_isRequired == null) 
                m_isRequired = new Dictionary<string, Func<HumanAggregateCaseDeduplicationListItem, bool>>();
            if (!m_isRequired.ContainsKey(name))
                m_isRequired.Add(name, func);
        }
    
    internal Dictionary<string, Func<HumanAggregateCaseDeduplicationListItem, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<HumanAggregateCaseDeduplicationListItem, bool> func)
    {
      if (m_isHiddenPersonalData == null)
        m_isHiddenPersonalData = new Dictionary<string, Func<HumanAggregateCaseDeduplicationListItem, bool>>();
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        ~HumanAggregateCaseDeduplicationListItem()
        {
            Dispose();
        }
        public void Dispose()
        ...
        public class HumanAggregateCaseDeduplicationListItemGridModel : IGridModelItem
        {
        ...
        public partial class HumanAggregateCaseDeduplicationListItemGridModelList : List<HumanAggregateCaseDeduplicationListItemGridModel>, IGridModelList, IGridModelListLoad
        {
            ...
            public HumanAggregateCaseDeduplicationListItemGridModelList()
            {
            }
            public void Load(long key, IEnumerable items, string errMes)
            {
                LoadGridModelList(key, items as IEnumerable<HumanAggregateCaseDeduplicationListItem>, errMes);
            }
            public HumanAggregateCaseDeduplicationListItemGridModelList(long key, IEnumerable items, string errMes)
            {
                LoadGridModelList(key, items as IEnumerable<HumanAggregateCaseDeduplicationListItem>, errMes);
            }
            public HumanAggregateCaseDeduplicationListItemGridModelList(long key, IEnumerable<HumanAggregateCaseDeduplicationListItem> items)
            {
                LoadGridModelList(key, items, null);
            }
            public HumanAggregateCaseDeduplicationListItemGridModelList(long key)
            {
                LoadGridModelList(key, new List<HumanAggregateCaseDeduplicationListItem>(), null);
            }
            partial void filter(List<HumanAggregateCaseDeduplicationListItem> items);
            private void LoadGridModelList(long key, IEnumerable<HumanAggregateCaseDeduplicationListItem> items, string errMes)
            {
                ListKey = key;
                ...
                HumanAggregateCaseDeduplicationListItem.Meta.Actions.ForEach(a => Actions.Add("@" + a.Name, a));
                var list = new List<HumanAggregateCaseDeduplicationListItem>(items);
                filter(list);
                AddRange(list.Where(c => !c.IsMarkedToDelete).Select(c => new HumanAggregateCaseDeduplicationListItemGridModel()
                {
        ...
        : DataAccessor<HumanAggregateCaseDeduplicationListItem>
            , IObjectAccessor
            , IObjectMeta
            , IObjectValidator
            ...
            , IObjectCreator
            , IObjectCreator<HumanAggregateCaseDeduplicationListItem>
            
            , IObjectSelectList
            , IObjectSelectList<HumanAggregateCaseDeduplicationListItem>
                    ...
                    
        {
            ...
            public delegate void on_action(HumanAggregateCaseDeduplicationListItem obj);
            ...
            public virtual List<HumanAggregateCaseDeduplicationListItem> SelectListT(DbManagerProxy manager
            ...
            protected virtual List<HumanAggregateCaseDeduplicationListItem> _SelectList(DbManagerProxy manager
                ...
                )
            {
                ...
                sql.Append(@"top ");
                sql.Append(maxtop);
                sql.Append(@" dbo.fn_AggregateCaseDeduplication_SelectList.* from dbo.fn_AggregateCaseDeduplication_SelectList(@LangID
                    ) ");
                ...
                {
                    sql.Append(@" and exists (select * from  tflAggrCaseFiltered f inner join tflSiteToSiteGroup on tflSiteToSiteGroup.idfSiteGroup = f.idfSiteGroup and tflSiteToSiteGroup.idfsSite = " + EidssSiteContext.Instance.SiteID.ToString() + " where f.idfAggrCase = fn_AggregateCaseDeduplication_SelectList.idfAggrCase)");
                }
                ...
                if (filters.Contains("idfAggrCase"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfAggrCase"); i++)
                    {
                        ...
                        if (filters.Operation("idfAggrCase", i) == "&")
                          sql.AppendFormat("(isnull(fn_AggregateCaseDeduplication_SelectList.idfAggrCase,0) {0} @idfAggrCase_{1} = @idfAggrCase_{1})", filters.Operation("idfAggrCase", i), i);
                        else
                          sql.AppendFormat("isnull(fn_AggregateCaseDeduplication_SelectList.idfAggrCase,0) {0} @idfAggrCase_{1}", filters.Operation("idfAggrCase", i), i);
                ...
                if (filters.Contains("intDuplicateGroup"))
                {
                    ...
                    for (int i = 0; i < filters.Count("intDuplicateGroup"); i++)
                    {
                        ...
                        if (filters.Operation("intDuplicateGroup", i) == "&")
                          sql.AppendFormat("(isnull(fn_AggregateCaseDeduplication_SelectList.intDuplicateGroup,0) {0} @intDuplicateGroup_{1} = @intDuplicateGroup_{1})", filters.Operation("intDuplicateGroup", i), i);
                        else
                          sql.AppendFormat("isnull(fn_AggregateCaseDeduplication_SelectList.intDuplicateGroup,0) {0} @intDuplicateGroup_{1}", filters.Operation("intDuplicateGroup", i), i);
                ...
                if (filters.Contains("strCaseID"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strCaseID"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_AggregateCaseDeduplication_SelectList.strCaseID {0} @strCaseID_{1}", filters.Operation("strCaseID", i), i);
                ...
                if (filters.Contains("datStartDate"))
                {
                    ...
                    for (int i = 0; i < filters.Count("datStartDate"); i++)
                    {
                        ...
                        sql.AppendFormat("CONVERT(NVARCHAR(8), fn_AggregateCaseDeduplication_SelectList.datStartDate, 112) {0} CONVERT(NVARCHAR(8), @datStartDate_{1}, 112)", filters.Operation("datStartDate", i), i);
                ...
                if (filters.Contains("strPeriodName"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strPeriodName"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_AggregateCaseDeduplication_SelectList.strPeriodName {0} @strPeriodName_{1}", filters.Operation("strPeriodName", i), i);
                ...
                if (filters.Contains("strRegion"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strRegion"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_AggregateCaseDeduplication_SelectList.strRegion {0} @strRegion_{1}", filters.Operation("strRegion", i), i);
                ...
                if (filters.Contains("strRayon"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strRayon"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_AggregateCaseDeduplication_SelectList.strRayon {0} @strRayon_{1}", filters.Operation("strRayon", i), i);
                ...
                if (filters.Contains("strSettlement"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strSettlement"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_AggregateCaseDeduplication_SelectList.strSettlement {0} @strSettlement_{1}", filters.Operation("strSettlement", i), i);
                ...
                if (filters.Contains("strInstitutionName"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strInstitutionName"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_AggregateCaseDeduplication_SelectList.strInstitutionName {0} @strInstitutionName_{1}", filters.Operation("strInstitutionName", i), i);
                ...
                if (filters.Contains("datEnteredByDate"))
                {
                    ...
                    for (int i = 0; i < filters.Count("datEnteredByDate"); i++)
                    {
                        ...
                        sql.AppendFormat("CONVERT(NVARCHAR(8), fn_AggregateCaseDeduplication_SelectList.datEnteredByDate, 112) {0} CONVERT(NVARCHAR(8), @datEnteredByDate_{1}, 112)", filters.Operation("datEnteredByDate", i), i);
                ...
                if (filters.Contains("strMatrixName"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strMatrixName"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_AggregateCaseDeduplication_SelectList.strMatrixName {0} @strMatrixName_{1}", filters.Operation("strMatrixName", i), i);
                ...
                if (filters.Contains("strTemplateName"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strTemplateName"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_AggregateCaseDeduplication_SelectList.strTemplateName {0} @strTemplateName_{1}", filters.Operation("strTemplateName", i), i);
                ...
                try
                {
                    ...
                    List<HumanAggregateCaseDeduplicationListItem> objs = manager.ExecuteList<HumanAggregateCaseDeduplicationListItem>();
            ...
            partial void ListSelected(DbManagerProxy manager, List<HumanAggregateCaseDeduplicationListItem> objs);
            ...
            internal void _SetupLoad(DbManagerProxy manager, HumanAggregateCaseDeduplicationListItem obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            internal void _SetPermitions(IObjectPermissions permissions, HumanAggregateCaseDeduplicationListItem obj)
            {
                if (obj != null)
                {
            ...
            private HumanAggregateCaseDeduplicationListItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                HumanAggregateCaseDeduplicationListItem obj = null;
                try
                {
                    obj = HumanAggregateCaseDeduplicationListItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public HumanAggregateCaseDeduplicationListItem CreateNewT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public HumanAggregateCaseDeduplicationListItem CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public HumanAggregateCaseDeduplicationListItem CreateWithParamsT(DbManagerProxy manager, IObject Parent, List<object> pars)
            {
            ...
            public ActResult FindDuplicates(DbManagerProxy manager, HumanAggregateCaseDeduplicationListItem obj, List<object> pars)
            {
                
                return FindDuplicates(manager, obj
                    );
            }
            public ActResult FindDuplicates(DbManagerProxy manager, HumanAggregateCaseDeduplicationListItem obj
                )
            {
                
                if (obj != null && !obj.GetPermissions().CanExecute("FindDuplicates"))
                    throw new PermissionException("AccessToHumanAggregateCase", "FindDuplicates");
            ...
            public ActResult ActionEditHumanAggregateCase(DbManagerProxy manager, HumanAggregateCaseDeduplicationListItem obj, List<object> pars)
            {
                
                return ActionEditHumanAggregateCase(manager, obj
                    );
            }
            public ActResult ActionEditHumanAggregateCase(DbManagerProxy manager, HumanAggregateCaseDeduplicationListItem obj
                )
            {
            ...
            private void _SetupChildHandlers(HumanAggregateCaseDeduplicationListItem obj, object newobj)
            {
                
            }
            
            private void _SetupHandlers(HumanAggregateCaseDeduplicationListItem obj)
            {
                
            }
    

            internal void _LoadLookups(DbManagerProxy manager, HumanAggregateCaseDeduplicationListItem obj)
            {
            ...
            public bool Post(DbManagerProxy manager, IObject obj, bool bChildObject = false)
            {
                ...
                for (int iAttemptNumber = 0; iAttemptNumber < iDeadlockAttemptsCount; iAttemptNumber++)
                {
                    ...
                    try
                    {
                        HumanAggregateCaseDeduplicationListItem bo = obj as HumanAggregateCaseDeduplicationListItem;
                        ...
                        bSuccess = _PostNonTransaction(manager, obj as HumanAggregateCaseDeduplicationListItem, bChildObject);
                        if (bTransactionStarted)
                        {
                            if (bSuccess)
                            {
            ...
            private bool _PostNonTransaction(DbManagerProxy manager, HumanAggregateCaseDeduplicationListItem obj, bool bChildObject) 
            { 
            ...
            public bool ValidateCanDelete(HumanAggregateCaseDeduplicationListItem obj)
            {
                using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
                {
            ...
            public bool ValidateCanDelete(DbManagerProxy manager, HumanAggregateCaseDeduplicationListItem obj)
            {
            ...
            protected ValidationModelException ChainsValidate(HumanAggregateCaseDeduplicationListItem obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(HumanAggregateCaseDeduplicationListItem obj, bool bRethrowException)
            {
            ...
            {
                return Validate(manager, obj as HumanAggregateCaseDeduplicationListItem, bPostValidation, bChangeValidation, bDeepValidation, bRethrowException);
            }
            public bool Validate(DbManagerProxy manager, HumanAggregateCaseDeduplicationListItem obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
            ...
            private void _SetupRequired(HumanAggregateCaseDeduplicationListItem obj)
            {
            
            }
    
    private void _SetupPersonalDataRestrictions(HumanAggregateCaseDeduplicationListItem obj)
    {
            ...
            public bool RequiredByField(string name, IObject obj) { return Meta.RequiredByField.ContainsKey(name) ? Meta.RequiredByField[name](obj as HumanAggregateCaseDeduplicationListItem) : false; }
            public bool RequiredByProperty(string name, IObject obj) { return Meta.RequiredByProperty.ContainsKey(name) ? Meta.RequiredByProperty[name](obj as HumanAggregateCaseDeduplicationListItem) : false; }
            public List<SearchPanelMetaItem> SearchPanelMeta { get { return Meta.SearchPanelMeta; } }
            public List<GridMetaItem> GridMeta { get { return Meta.GridMeta; } }
            public List<ActionMetaItem> Actions { get { return Meta.Actions; } }
            public string DetailPanel { get { return "HumanAggregateCaseDeduplicationListItemDetail"; } }
            public string HelpIdWin { get { return "HAC_deduplication"; } }
            public string HelpIdWeb { get { return "HAC_deduplication"; } }
        ...
        {
            private HumanAggregateCaseDeduplicationListItem m_obj;
            internal Permissions(HumanAggregateCaseDeduplicationListItem obj)
            {
                m_obj = obj;
            }
        ...
        {
            public static string spSelect = "fn_AggregateCaseDeduplication_SelectList";
            ...
            public static Dictionary<string, Func<HumanAggregateCaseDeduplicationListItem, bool>> RequiredByField = new Dictionary<string, Func<HumanAggregateCaseDeduplicationListItem, bool>>();
            public static Dictionary<string, Func<HumanAggregateCaseDeduplicationListItem, bool>> RequiredByProperty = new Dictionary<string, Func<HumanAggregateCaseDeduplicationListItem, bool>>();
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).FindDuplicates(manager, (HumanAggregateCaseDeduplicationListItem)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).ActionEditHumanAggregateCase(manager, (HumanAggregateCaseDeduplicationListItem)c, pars),
                    ...
                    (manager, c, pars) => 
                        {
                            if (c == null)
                            {
                                c = ObjectAccessor.CreatorInterface<HumanAggregateCaseDeduplicationListItem>().CreateWithParams(manager, null, pars);
                                ((HumanAggregateCaseDeduplicationListItem)c).idfAggrCase = (long)pars[0];
                                ((HumanAggregateCaseDeduplicationListItem)c).m_IsNew = false;
                            }
                            return new ActResult(((HumanAggregateCaseDeduplicationListItem)c).MarkToDelete() && ObjectAccessor.PostInterface<HumanAggregateCaseDeduplicationListItem>().Post(manager, (HumanAggregateCaseDeduplicationListItem)c), c);
                        }
                                            ,
                    null,
                    new ActionMetaItem.VisualItem(
