...
namespace eidss.model.Schema
{
    ...
    public abstract partial class TransportCHE : 
        EditableObject<TransportCHE>
        , IObject
        , IDisposable
        , ILookupUsage
        {
        ...
        protected class field_info
        {
            ...
            internal Func<TransportCHE, object> _get_func;
            internal Action<TransportCHE, string> _set_func;
            internal Action<TransportCHE, TransportCHE, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        internal CompareModel _compare(IObject o, CompareModel ret)
        {
            ...
            TransportCHE obj = (TransportCHE)o;
        ...
        [Relation(typeof(RegionForAzReportLookup), eidss.model.Schema.RegionForAzReportLookup._str_idfsRegion, _str_idfsRegion)]
        public RegionForAzReportLookup Region
        {
        ...
        private RegionForAzReportLookup _Region;

        
        public List<RegionForAzReportLookup> RegionLookup
        {
            get { return _RegionLookup; }
        }
        private List<RegionForAzReportLookup> _RegionLookup = new List<RegionForAzReportLookup>();
        ...
        private BvSelectList _getList(string name)
        {
            ...
            switch(name)
            {
                ...
                case _str_Region:
                    return new BvSelectList(RegionLookup, eidss.model.Schema.RegionForAzReportLookup._str_idfsRegion, null, Region, _str_idfsRegion);
        ...
        internal string m_ObjectName = "TransportCHE";
        ...
        {
            var ret = base.Clone() as TransportCHE;
            ret.bIsClone = true;
            ret.Cloned();
        ...
        public TransportCHE CloneWithSetup()
        {
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                return CloneWithSetup(manager) as TransportCHE;
            }
        }
        #endregion
        ...
        private bool IsRIRPropChanged(string fld, TransportCHE c)
        {
            return IsReadOnly(fld) != c.IsReadOnly(fld) || IsInvisible(fld) != c.IsInvisible(fld) || IsRequired(fld) != c._isRequired(m_isRequired, fld);
        }
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, TransportCHE c)
        {
        ...
        {
            PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(TransportCHE_PropertyChanged);
        }
        public void _RevokeMainHandler()
        {
            PropertyChanged -= new System.ComponentModel.PropertyChangedEventHandler(TransportCHE_PropertyChanged);
        }
        private void TransportCHE_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            (sender as TransportCHE).Changed(e.PropertyName);
        ...
        private static string[] readonly_names1 = "Rayon,idfsRayon".Split(new char[] { ',' });
        
        private bool _isReadOnly(string name)
        {
            
            if (readonly_names1.Where(c => c == name).Count() > 0)
                return ReadOnly || new Func<TransportCHE, bool>(c => c.idfsRegion == null)(this);
        ...
        internal Dictionary<string, Func<TransportCHE, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<TransportCHE, bool>> isRequiredDict, string name)
        {
        ...
        public void AddRequired(string name, Func<TransportCHE, bool> func)
        {
            if (m_isRequired == null) 
                m_isRequired = new Dictionary<string, Func<TransportCHE, bool>>();
            if (!m_isRequired.ContainsKey(name))
                m_isRequired.Add(name, func);
        }
    
    internal Dictionary<string, Func<TransportCHE, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<TransportCHE, bool> func)
    {
      if (m_isHiddenPersonalData == null)
        m_isHiddenPersonalData = new Dictionary<string, Func<TransportCHE, bool>>();
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        public void Dispose()
        {
            if (!bIsDisposed) 
            {
                ...
                LookupManager.RemoveObject("RegionForAzReportLookup", this);
        ...
        public void ReloadLookupItem(DbManagerProxy manager, string lookup_object)
        {
            ...
            if (lookup_object == "RegionForAzReportLookup")
        ...
        : DataAccessor<TransportCHE>
            , IObjectAccessor
            , IObjectMeta
            , IObjectValidator
            
            , IObjectCreator
            , IObjectCreator<TransportCHE>
            
            , IObjectSelectDetail
            , IObjectSelectDetail<TransportCHE>
            , IObjectPost
            , IObjectDelete
                    
        {
            ...
            public delegate void on_action(TransportCHE obj);
            ...
            private RegionForAzReportLookup.Accessor RegionAccessor { get { return eidss.model.Schema.RegionForAzReportLookup.Accessor.Instance(m_CS); } }
            ...
            public virtual TransportCHE SelectDetailT(DbManagerProxy manager, object ident, int? HACode = null)
            {
                if (ident == null)
                {
            ...
            public virtual TransportCHE SelectByKey(DbManagerProxy manager
                )
            {
                return _SelectByKey(manager
                    , null, null
            ...
            private TransportCHE _SelectByKey(DbManagerProxy manager
            ...
            protected virtual TransportCHE _SelectByKeyInternal(DbManagerProxy manager
                , on_action loading, on_action loaded
                )
            {
            
                MapResultSet[] sets = new MapResultSet[1];
                List<TransportCHE> objs = new List<TransportCHE>();
                sets[0] = new MapResultSet(typeof(TransportCHE), objs);
                TransportCHE obj = null;
                try
                {
                    manager
                        .SetSpCommand("spTransportCHE_SelectDetail"
                            )
            ...
            internal void _SetupLoad(DbManagerProxy manager, TransportCHE obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            internal void _SetPermitions(IObjectPermissions permissions, TransportCHE obj)
            {
                if (obj != null)
                {
            ...
            private TransportCHE _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                TransportCHE obj = null;
                try
                {
                    obj = TransportCHE.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
              ...
              obj.idfGeoLocation = 1L;
                ...
                obj.Country = new Func<TransportCHE, CountryLookup>(c => 
            ...
            public TransportCHE CreateNewT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public TransportCHE CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public TransportCHE CreateWithParamsT(DbManagerProxy manager, IObject Parent, List<object> pars)
            {
            ...
            private void _SetupChildHandlers(TransportCHE obj, object newobj)
            {
                
            }
            
            private void _SetupHandlers(TransportCHE obj)
            {
            ...
            public void LoadLookup_Country(DbManagerProxy manager, TransportCHE obj)
            {
            ...
            public void LoadLookup_Region(DbManagerProxy manager, TransportCHE obj)
            {
                ...
                obj.RegionLookup.AddRange(RegionAccessor.SelectLookupList(manager
                    ...
                    , new Func<TransportCHE, long>(c => c.idfsCountry ?? 0)(obj)
                ...
                LookupManager.AddObject("RegionForAzReportLookup", obj, RegionAccessor.GetType(), "_SelectListInternal");
                obj.bNeedLookupRemove = true;
              
            }
            
            public void LoadLookup_Rayon(DbManagerProxy manager, TransportCHE obj)
            {
                ...
                obj.RayonLookup.AddRange(RayonAccessor.SelectLookupList(manager
                    ...
                    , new Func<TransportCHE, long>(c => c.idfsRegion ?? 0)(obj)
                            
                    , null
                    , new Func<TransportCHE, long?>(c => (long)AggregateCaseType.HumanAggregateCase)(obj)
            ...
            internal void _LoadLookups(DbManagerProxy manager, TransportCHE obj)
            {
            ...
            [SprocName("spTransportCHE_Post")]
            protected abstract void _post(DbManagerProxy manager, 
                [Direction.InputOutput()] TransportCHE obj);
            ...
            public bool Post(DbManagerProxy manager, IObject obj, bool bChildObject = false)
            {
                ...
                for (int iAttemptNumber = 0; iAttemptNumber < iDeadlockAttemptsCount; iAttemptNumber++)
                {
                    ...
                    try
                    {
                        TransportCHE bo = obj as TransportCHE;
                        ...
                        bSuccess = _PostNonTransaction(manager, obj as TransportCHE, bChildObject);
            ...
            private bool _PostNonTransaction(DbManagerProxy manager, TransportCHE obj, bool bChildObject) 
            { 
            ...
            public bool ValidateCanDelete(TransportCHE obj)
            {
                using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
                {
            ...
            public bool ValidateCanDelete(DbManagerProxy manager, TransportCHE obj)
            {
            ...
            protected ValidationModelException ChainsValidate(TransportCHE obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(TransportCHE obj, bool bRethrowException)
            {
            ...
            {
                return Validate(manager, obj as TransportCHE, bPostValidation, bChangeValidation, bDeepValidation, bRethrowException);
            }
            public bool Validate(DbManagerProxy manager, TransportCHE obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
            ...
            private void _SetupRequired(TransportCHE obj)
            {
            
            }
    
    private void _SetupPersonalDataRestrictions(TransportCHE obj)
    {
            ...
            public bool RequiredByField(string name, IObject obj) { return Meta.RequiredByField.ContainsKey(name) ? Meta.RequiredByField[name](obj as TransportCHE) : false; }
            public bool RequiredByProperty(string name, IObject obj) { return Meta.RequiredByProperty.ContainsKey(name) ? Meta.RequiredByProperty[name](obj as TransportCHE) : false; }
            public List<SearchPanelMetaItem> SearchPanelMeta { get { return Meta.SearchPanelMeta; } }
            public List<GridMetaItem> GridMeta { get { return Meta.GridMeta; } }
            public List<ActionMetaItem> Actions { get { return Meta.Actions; } }
            public string DetailPanel { get { return "TransportCHEDetail"; } }
        ...
        {
            public static string spSelect = "spTransportCHE_SelectDetail";
            public static string spCount = "";
            public static string spPost = "spTransportCHE_Post";
            ...
            public static Dictionary<string, Func<TransportCHE, bool>> RequiredByField = new Dictionary<string, Func<TransportCHE, bool>>();
            public static Dictionary<string, Func<TransportCHE, bool>> RequiredByProperty = new Dictionary<string, Func<TransportCHE, bool>>();
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(ObjectAccessor.PostInterface<TransportCHE>().Post(manager, (TransportCHE)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(((TransportCHE)c).MarkToDelete() && ObjectAccessor.PostInterface<TransportCHE>().Post(manager, (TransportCHE)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
