...
namespace eidss.model.Schema
{
    ...
    public abstract partial class PostalCodeLookup : 
        ...
        protected class field_info
        {
            ...
            internal Action<PostalCodeLookup, PostalCodeLookup, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_idfPostalCode, _formname = _str_idfPostalCode, _type = "Int64",
              _get_func = o => o.idfPostalCode,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseInt64(val); if (o.idfPostalCode != newval) o.idfPostalCode = newval; },
              _compare_func = (o, c, m, g) => {
                if (o.idfPostalCode != c.idfPostalCode || o.IsRIRPropChanged(_str_idfPostalCode, c)) 
                  m.Add(_str_idfPostalCode, o.ObjectIdent + _str_idfPostalCode, o.ObjectIdent2 + _str_idfPostalCode, o.ObjectIdent3 + _str_idfPostalCode, "Int64", 
                    o.idfPostalCode == null ? "" : o.idfPostalCode.ToString(),                  
                  o.IsReadOnly(_str_idfPostalCode), o.IsInvisible(_str_idfPostalCode), o.IsRequired(_str_idfPostalCode)); 
                  }
              }, 
        ...
        public object KeyLookup { get { return strPostCode; } }
        ...
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, PostalCodeLookup c)
        {
        ...
        internal Dictionary<string, Func<PostalCodeLookup, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<PostalCodeLookup, bool>> isRequiredDict, string name)
        {
    ...
    internal Dictionary<string, Func<PostalCodeLookup, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<PostalCodeLookup, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        : DataAccessor<PostalCodeLookup>
            ...
            , IObjectCreator
            , IObjectCreator<PostalCodeLookup>
            
        {
            ...
            public delegate void on_action(PostalCodeLookup obj);
            ...
            internal void _SetupLoad(DbManagerProxy manager, PostalCodeLookup obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            private PostalCodeLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                PostalCodeLookup obj = null;
                try
                {
                    obj = PostalCodeLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public PostalCodeLookup CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            internal void _LoadLookups(DbManagerProxy manager, PostalCodeLookup obj)
            {
            ...
            protected ValidationModelException ChainsValidate(PostalCodeLookup obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(PostalCodeLookup obj, bool bRethrowException)
            {
