...
namespace eidss.model.Schema
{
    ...
    public abstract partial class AsSessionSummarySample : 
        ...
        protected String id_Original { get { return ((EditableValue<String>)((dynamic)this)._id).OriginalValue; } }
        protected String id_Previous { get { return ((EditableValue<String>)((dynamic)this)._id).PreviousValue; } }
                
        [MapField(_str_idfsSampleType), NonUpdatable, PrimaryKey]
        ...
        protected class field_info
        {
            ...
            internal Action<AsSessionSummarySample, AsSessionSummarySample, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_id, _formname = _str_id, _type = "String",
              _get_func = o => o.id,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseString(val); if (o.id != newval) o.id = newval; },
              _compare_func = (o, c, m, g) => {
                if (o.id != c.id || o.IsRIRPropChanged(_str_id, c)) 
                  m.Add(_str_id, o.ObjectIdent + _str_id, o.ObjectIdent2 + _str_id, o.ObjectIdent3 + _str_id, "String", 
            ...
            new field_info {
              ...
              _set_func = (o, val) => { var newval = ParsingHelper.ParseInt64Nullable(val); if (o.idfMonitoringSessionSummary != newval) o.idfMonitoringSessionSummary = newval; },
              _compare_func = (o, c, m, g) => {
            ...
            new field_info {
              _name = _str_blnChecked, _formname = _str_blnChecked, _type = "Boolean?",
              _get_func = o => o.blnChecked,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseBooleanNullable(val); if (o.blnChecked != newval) o.blnChecked = newval; },
              _compare_func = (o, c, m, g) => {
                if (o.blnChecked != c.blnChecked || o.IsRIRPropChanged(_str_blnChecked, c)) 
                  m.Add(_str_blnChecked, o.ObjectIdent + _str_blnChecked, o.ObjectIdent2 + _str_blnChecked, o.ObjectIdent3 + _str_blnChecked, "Boolean?", 
                    o.blnChecked == null ? "" : o.blnChecked.ToString(),                  
                  o.IsReadOnly(_str_blnChecked), o.IsInvisible(_str_blnChecked), o.IsRequired(_str_blnChecked)); 
                  }
              }, 
        ...
        public object Key { get { return idfsSampleType; } }
        public string KeyName { get { return "idfsSampleType"; } }
        public object KeyLookup { get { return idfsSampleType; } }
        ...
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, AsSessionSummarySample c)
        {
        ...
        internal Dictionary<string, Func<AsSessionSummarySample, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<AsSessionSummarySample, bool>> isRequiredDict, string name)
        {
    ...
    internal Dictionary<string, Func<AsSessionSummarySample, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<AsSessionSummarySample, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        : DataAccessor<AsSessionSummarySample>
            ...
            , IObjectCreator
            , IObjectCreator<AsSessionSummarySample>
                ...
                
        {
            ...
            public delegate void on_action(AsSessionSummarySample obj);
            ...
            public List<AsSessionSummarySample> _SelectList(DbManagerProxy manager
                , Int64? idfMonitoringSessionSummary
            ...
            public virtual List<AsSessionSummarySample> _SelectListInternal(DbManagerProxy manager
                , Int64? idfMonitoringSessionSummary
                , on_action loading, on_action loaded
                )
            {
                AsSessionSummarySample _obj = null;
                try
                {
            ...
            internal void _SetupLoad(DbManagerProxy manager, AsSessionSummarySample obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            private AsSessionSummarySample _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                AsSessionSummarySample obj = null;
                try
                {
                    obj = AsSessionSummarySample.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public AsSessionSummarySample CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            internal void _LoadLookups(DbManagerProxy manager, AsSessionSummarySample obj)
            {
            ...
            protected ValidationModelException ChainsValidate(AsSessionSummarySample obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(AsSessionSummarySample obj, bool bRethrowException)
            {
