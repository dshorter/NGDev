...
namespace eidss.model.Schema
{
    ...
    public abstract partial class RegionAggrLookup : 
        ...
        protected class field_info
        {
            ...
            internal Action<RegionAggrLookup, RegionAggrLookup, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, RegionAggrLookup c)
        {
        ...
        internal Dictionary<string, Func<RegionAggrLookup, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<RegionAggrLookup, bool>> isRequiredDict, string name)
        {
    ...
    internal Dictionary<string, Func<RegionAggrLookup, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<RegionAggrLookup, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        : DataAccessor<RegionAggrLookup>
            ...
            , IObjectCreator
            , IObjectCreator<RegionAggrLookup>
            
        {
            ...
            public delegate void on_action(RegionAggrLookup obj);
            ...
            public List<RegionAggrLookup> _SelectList(DbManagerProxy manager
                , Int64? CountryID
                , Int64? ID
                , Int64? idfsAggrCaseType
            ...
            public virtual List<RegionAggrLookup> _SelectListInternal(DbManagerProxy manager
                , Int64? CountryID
                , Int64? ID
                , Int64? idfsAggrCaseType
                , on_action loading, on_action loaded
            ...
            internal void _SetupLoad(DbManagerProxy manager, RegionAggrLookup obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            private RegionAggrLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                RegionAggrLookup obj = null;
                try
                {
                    obj = RegionAggrLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public RegionAggrLookup CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            internal void _LoadLookups(DbManagerProxy manager, RegionAggrLookup obj)
            {
            ...
            protected ValidationModelException ChainsValidate(RegionAggrLookup obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(RegionAggrLookup obj, bool bRethrowException)
            {
