...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VetAggregateActionListItem : 
        ...
        protected class field_info
        {
            ...
            internal Action<VetAggregateActionListItem, VetAggregateActionListItem, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, VetAggregateActionListItem c)
        {
        ...
        internal Dictionary<string, Func<VetAggregateActionListItem, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<VetAggregateActionListItem, bool>> isRequiredDict, string name)
        {
    ...
    internal Dictionary<string, Func<VetAggregateActionListItem, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<VetAggregateActionListItem, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        public partial class VetAggregateActionListItemGridModelList : List<VetAggregateActionListItemGridModel>, IGridModelList, IGridModelListLoad
        {
            ...
            public VetAggregateActionListItemGridModelList()
            {
            }
            ...
            public VetAggregateActionListItemGridModelList(long key)
            {
                LoadGridModelList(key, new List<VetAggregateActionListItem>(), null);
            }
            ...
            private void LoadGridModelList(long key, IEnumerable<VetAggregateActionListItem> items, string errMes)
            {
                ...
                VetAggregateActionListItem.Meta.Actions.ForEach(a => Actions.Add("@" + a.Name, a));
        ...
        : DataAccessor<VetAggregateActionListItem>
            ...
            , IObjectCreator
            , IObjectCreator<VetAggregateActionListItem>
            
            , IObjectSelectList
            , IObjectSelectList<VetAggregateActionListItem>
                    ...
                    
        {
            ...
            public delegate void on_action(VetAggregateActionListItem obj);
            ...
            protected virtual List<VetAggregateActionListItem> _SelectList(DbManagerProxy manager
                ...
                )
            {
                ...
                {
                    sql.Append(@" and exists (select * from  tflAggrCaseFiltered f inner join tflSiteToSiteGroup on tflSiteToSiteGroup.idfSiteGroup = f.idfSiteGroup and tflSiteToSiteGroup.idfsSite = " + EidssSiteContext.Instance.SiteID.ToString() + " where f.idfAggrCase = fn_VetAggregateAction_SelectList.idfAggrCase)");
                }
                ...
                if (filters.Contains("idfAggrCase"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfAggrCase"); i++)
                    {
                        ...
                        if (filters.Operation("idfAggrCase", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfAggrCase,0) {0} @idfAggrCase_{1} = @idfAggrCase_{1})", filters.Operation("idfAggrCase", i), i);
                        else
                ...
                if (filters.Contains("idfsAggrCaseType"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfsAggrCaseType"); i++)
                    {
                        ...
                        if (filters.Operation("idfsAggrCaseType", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfsAggrCaseType,0) {0} @idfsAggrCaseType_{1} = @idfsAggrCaseType_{1})", filters.Operation("idfsAggrCaseType", i), i);
                        else
                ...
                if (filters.Contains("idfsAdministrativeUnit"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfsAdministrativeUnit"); i++)
                    {
                        ...
                        if (filters.Operation("idfsAdministrativeUnit", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfsAdministrativeUnit,0) {0} @idfsAdministrativeUnit_{1} = @idfsAdministrativeUnit_{1})", filters.Operation("idfsAdministrativeUnit", i), i);
                        else
                ...
                if (filters.Contains("idfReceivedByOffice"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfReceivedByOffice"); i++)
                    {
                        ...
                        if (filters.Operation("idfReceivedByOffice", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfReceivedByOffice,0) {0} @idfReceivedByOffice_{1} = @idfReceivedByOffice_{1})", filters.Operation("idfReceivedByOffice", i), i);
                        else
                ...
                if (filters.Contains("idfReceivedByPerson"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfReceivedByPerson"); i++)
                    {
                        ...
                        if (filters.Operation("idfReceivedByPerson", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfReceivedByPerson,0) {0} @idfReceivedByPerson_{1} = @idfReceivedByPerson_{1})", filters.Operation("idfReceivedByPerson", i), i);
                        else
                ...
                if (filters.Contains("idfSentByOffice"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfSentByOffice"); i++)
                    {
                        ...
                        if (filters.Operation("idfSentByOffice", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfSentByOffice,0) {0} @idfSentByOffice_{1} = @idfSentByOffice_{1})", filters.Operation("idfSentByOffice", i), i);
                        else
                ...
                if (filters.Contains("idfSentByPerson"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfSentByPerson"); i++)
                    {
                        ...
                        if (filters.Operation("idfSentByPerson", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfSentByPerson,0) {0} @idfSentByPerson_{1} = @idfSentByPerson_{1})", filters.Operation("idfSentByPerson", i), i);
                        else
                ...
                if (filters.Contains("idfEnteredByOffice"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfEnteredByOffice"); i++)
                    {
                        ...
                        if (filters.Operation("idfEnteredByOffice", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfEnteredByOffice,0) {0} @idfEnteredByOffice_{1} = @idfEnteredByOffice_{1})", filters.Operation("idfEnteredByOffice", i), i);
                        else
                ...
                if (filters.Contains("idfEnteredByPerson"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfEnteredByPerson"); i++)
                    {
                        ...
                        if (filters.Operation("idfEnteredByPerson", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfEnteredByPerson,0) {0} @idfEnteredByPerson_{1} = @idfEnteredByPerson_{1})", filters.Operation("idfEnteredByPerson", i), i);
                        else
                ...
                if (filters.Contains("idfsAreaType"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfsAreaType"); i++)
                    {
                        ...
                        if (filters.Operation("idfsAreaType", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfsAreaType,0) {0} @idfsAreaType_{1} = @idfsAreaType_{1})", filters.Operation("idfsAreaType", i), i);
                        else
                ...
                if (filters.Contains("idfsCountry"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfsCountry"); i++)
                    {
                        ...
                        if (filters.Operation("idfsCountry", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfsCountry,0) {0} @idfsCountry_{1} = @idfsCountry_{1})", filters.Operation("idfsCountry", i), i);
                        else
                ...
                if (filters.Contains("idfsRegion"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfsRegion"); i++)
                    {
                        ...
                        if (filters.Operation("idfsRegion", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfsRegion,0) {0} @idfsRegion_{1} = @idfsRegion_{1})", filters.Operation("idfsRegion", i), i);
                        else
               ...
               if(EidssSiteContext.Instance.IsThaiCustomization)
                {
                    try
                    {
                        if (filters.Contains("idfsRayon"))
                        {
                            ...
                            sql.AppendFormat(" and (");
                            sql.AppendFormat("(Cast(isnull(fn_VetAggregateAction_SelectList.idfsRayon,0) as varchar(100)) in (select[Value] from fnsysSplitList(\'{0}\', 0, ',')))", list);
                            sql.AppendFormat(")");
                        }
                    }
                    catch (Exception e)
                        ...
                        if (filters.Contains("idfsRayon"))
                        {
                            ...
                            for (int i = 0; i < filters.Count("idfsRayon"); i++)
                            {
                                ...
                                if (filters.Operation("idfsRayon", i) == "&")
                                    sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfsRayon,0) {0} @idfsRayon_{1} = @idfsRayon_{1})", filters.Operation("idfsRayon", i), i);
                                else
                ...
                if (filters.Contains("idfsSettlement"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfsSettlement"); i++)
                    {
                        ...
                        if (filters.Operation("idfsSettlement", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfsSettlement,0) {0} @idfsSettlement_{1} = @idfsSettlement_{1})", filters.Operation("idfsSettlement", i), i);
                        else
                ...
                if (filters.Contains("idfsPeriodType"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfsPeriodType"); i++)
                    {
                        ...
                        if (filters.Operation("idfsPeriodType", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfsPeriodType,0) {0} @idfsPeriodType_{1} = @idfsPeriodType_{1})", filters.Operation("idfsPeriodType", i), i);
                        else
                ...
                if (filters.Contains("idfCaseObservation"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfCaseObservation"); i++)
                    {
                        ...
                        if (filters.Operation("idfCaseObservation", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfCaseObservation,0) {0} @idfCaseObservation_{1} = @idfCaseObservation_{1})", filters.Operation("idfCaseObservation", i), i);
                        else
                ...
                if (filters.Contains("idfDiagnosticObservation"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfDiagnosticObservation"); i++)
                    {
                        ...
                        if (filters.Operation("idfDiagnosticObservation", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfDiagnosticObservation,0) {0} @idfDiagnosticObservation_{1} = @idfDiagnosticObservation_{1})", filters.Operation("idfDiagnosticObservation", i), i);
                        else
                ...
                if (filters.Contains("idfProphylacticObservation"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfProphylacticObservation"); i++)
                    {
                        ...
                        if (filters.Operation("idfProphylacticObservation", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfProphylacticObservation,0) {0} @idfProphylacticObservation_{1} = @idfProphylacticObservation_{1})", filters.Operation("idfProphylacticObservation", i), i);
                        else
                ...
                if (filters.Contains("idfSanitaryObservation"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfSanitaryObservation"); i++)
                    {
                        ...
                        if (filters.Operation("idfSanitaryObservation", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfSanitaryObservation,0) {0} @idfSanitaryObservation_{1} = @idfSanitaryObservation_{1})", filters.Operation("idfSanitaryObservation", i), i);
                        else
                ...
                if (filters.Contains("idfsDiagnosticFormTemplate"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfsDiagnosticFormTemplate"); i++)
                    {
                        ...
                        if (filters.Operation("idfsDiagnosticFormTemplate", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfsDiagnosticFormTemplate,0) {0} @idfsDiagnosticFormTemplate_{1} = @idfsDiagnosticFormTemplate_{1})", filters.Operation("idfsDiagnosticFormTemplate", i), i);
                        else
                ...
                if (filters.Contains("idfsProphylacticFormTemplate"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfsProphylacticFormTemplate"); i++)
                    {
                        ...
                        if (filters.Operation("idfsProphylacticFormTemplate", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfsProphylacticFormTemplate,0) {0} @idfsProphylacticFormTemplate_{1} = @idfsProphylacticFormTemplate_{1})", filters.Operation("idfsProphylacticFormTemplate", i), i);
                        else
                ...
                if (filters.Contains("idfsSanitaryFormTemplate"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfsSanitaryFormTemplate"); i++)
                    {
                        ...
                        if (filters.Operation("idfsSanitaryFormTemplate", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfsSanitaryFormTemplate,0) {0} @idfsSanitaryFormTemplate_{1} = @idfsSanitaryFormTemplate_{1})", filters.Operation("idfsSanitaryFormTemplate", i), i);
                        else
                ...
                if (filters.Contains("idfsCaseFormTemplate"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfsCaseFormTemplate"); i++)
                    {
                        ...
                        if (filters.Operation("idfsCaseFormTemplate", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateAction_SelectList.idfsCaseFormTemplate,0) {0} @idfsCaseFormTemplate_{1} = @idfsCaseFormTemplate_{1})", filters.Operation("idfsCaseFormTemplate", i), i);
                        else
            ...
            partial void ListSelected(DbManagerProxy manager, List<VetAggregateActionListItem> objs);
            ...
            internal void _SetupLoad(DbManagerProxy manager, VetAggregateActionListItem obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            private VetAggregateActionListItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                VetAggregateActionListItem obj = null;
                try
                {
                    obj = VetAggregateActionListItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public VetAggregateActionListItem CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
                ...
                )
            {
                ...
                if (obj != null && !obj.GetPermissions().CanExecute("ActionEditVetAggregateActionCase"))
                    throw new PermissionException("AccessToVetAggregateAction", "ActionEditVetAggregateActionCase");
            ...
            internal void _LoadLookups(DbManagerProxy manager, VetAggregateActionListItem obj)
            {
            ...
            [SprocName("spVetAggregateAction_CanDelete")]
            ...
            protected ValidationModelException ChainsValidate(VetAggregateActionListItem obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(VetAggregateActionListItem obj, bool bRethrowException)
            {
    ...
    private void _SetupPersonalDataRestrictions(VetAggregateActionListItem obj)
    {
            ...
            public string HelpIdWin { get { return "VAA_search"; } }
            public string HelpIdWeb { get { return "VAA_search"; } }
        ...
        public static class Meta
        {
            ...
            public static string spCanDelete = "spVetAggregateAction_CanDelete";
    ...
    private static void AddHiddenPersonalData(string name, Func<bool> func)
    {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strCaseID,
                    "strActionID", null, true, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datStartDate,
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(true, ObjectAccessor.CreatorInterface<VetAggregateAction>().CreateNew(manager, c, pars == null ? null : (int?)pars[0])),
                    null,
                    new ActionMetaItem.VisualItem(
