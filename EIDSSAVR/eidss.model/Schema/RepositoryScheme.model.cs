...
namespace eidss.model.Schema
{
    ...
    public abstract partial class RepositoryScheme : 
        EditableObject<RepositoryScheme>
        , IObject
        , IDisposable
        , ILookupUsage
        {
        ...
        protected class field_info
        {
            ...
            internal Func<RepositoryScheme, object> _get_func;
            internal Action<RepositoryScheme, string> _set_func;
            internal Action<RepositoryScheme, RepositoryScheme, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        internal CompareModel _compare(IObject o, CompareModel ret)
        {
            ...
            RepositoryScheme obj = (RepositoryScheme)o;
        ...
        internal string m_ObjectName = "RepositoryScheme";
        ...
        {
            var ret = base.Clone() as RepositoryScheme;
            ret.bIsClone = true;
            ret.Cloned();
        ...
        public RepositoryScheme CloneWithSetup()
        {
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                return CloneWithSetup(manager) as RepositoryScheme;
            }
        }
        #endregion
        ...
        private bool IsRIRPropChanged(string fld, RepositoryScheme c)
        {
            return IsReadOnly(fld) != c.IsReadOnly(fld) || IsInvisible(fld) != c.IsInvisible(fld) || IsRequired(fld) != c._isRequired(m_isRequired, fld);
        }
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, RepositoryScheme c)
        {
        ...
        {
            PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(RepositoryScheme_PropertyChanged);
        }
        public void _RevokeMainHandler()
        {
            PropertyChanged -= new System.ComponentModel.PropertyChangedEventHandler(RepositoryScheme_PropertyChanged);
        }
        private void RepositoryScheme_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            (sender as RepositoryScheme).Changed(e.PropertyName);
        ...
        internal Dictionary<string, Func<RepositoryScheme, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<RepositoryScheme, bool>> isRequiredDict, string name)
        {
        ...
        public void AddRequired(string name, Func<RepositoryScheme, bool> func)
        {
            if (m_isRequired == null) 
                m_isRequired = new Dictionary<string, Func<RepositoryScheme, bool>>();
            if (!m_isRequired.ContainsKey(name))
                m_isRequired.Add(name, func);
        }
    
    internal Dictionary<string, Func<RepositoryScheme, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<RepositoryScheme, bool> func)
    {
      if (m_isHiddenPersonalData == null)
        m_isHiddenPersonalData = new Dictionary<string, Func<RepositoryScheme, bool>>();
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        : DataAccessor<RepositoryScheme>
            ...
            , IObjectCreator
            , IObjectCreator<RepositoryScheme>
            
            , IObjectSelectDetail
            , IObjectSelectDetail<RepositoryScheme>
            , IObjectPost
            , IObjectDelete
                    
        {
            ...
            public delegate void on_action(RepositoryScheme obj);
            ...
            public virtual RepositoryScheme SelectDetailT(DbManagerProxy manager, object ident, int? HACode = null)
            {
                if (ident == null)
                {
            ...
            public virtual RepositoryScheme SelectByKey(DbManagerProxy manager
                , Int64? idfFreezer
                )
            {
                return _SelectByKey(manager
            ...
            private RepositoryScheme _SelectByKey(DbManagerProxy manager
                , Int64? idfFreezer
            ...
            protected virtual RepositoryScheme _SelectByKeyInternal(DbManagerProxy manager
                , Int64? idfFreezer
                , on_action loading, on_action loaded
                )
            {
                ...
                List<RepositoryScheme> objs = new List<RepositoryScheme>();
                sets[0] = new MapResultSet(typeof(RepositoryScheme), objs);
                RepositoryScheme obj = null;
                try
                {
                    manager
                        .SetSpCommand("spRepositoryScheme_SelectDetail"
                            , manager.Parameter("@idfFreezer", idfFreezer)
                            )
            ...
            internal void _SetupLoad(DbManagerProxy manager, RepositoryScheme obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            internal void _SetPermitions(IObjectPermissions permissions, RepositoryScheme obj)
            {
                if (obj != null)
                {
            ...
            private RepositoryScheme _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                RepositoryScheme obj = null;
                try
                {
                    obj = RepositoryScheme.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public RepositoryScheme CreateNewT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public RepositoryScheme CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public RepositoryScheme CreateWithParamsT(DbManagerProxy manager, IObject Parent, List<object> pars)
            {
            ...
            private void _SetupChildHandlers(RepositoryScheme obj, object newobj)
            {
                
            }
            
            private void _SetupHandlers(RepositoryScheme obj)
            {
                
            }
    

            internal void _LoadLookups(DbManagerProxy manager, RepositoryScheme obj)
            {
            ...
            protected ValidationModelException ChainsValidate(RepositoryScheme obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(RepositoryScheme obj, bool bRethrowException)
            {
            ...
            {
                return Validate(manager, obj as RepositoryScheme, bPostValidation, bChangeValidation, bDeepValidation, bRethrowException);
            }
            public bool Validate(DbManagerProxy manager, RepositoryScheme obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
            ...
            private void _SetupRequired(RepositoryScheme obj)
            {
            
            }
    
    private void _SetupPersonalDataRestrictions(RepositoryScheme obj)
    {
            ...
            public bool RequiredByField(string name, IObject obj) { return Meta.RequiredByField.ContainsKey(name) ? Meta.RequiredByField[name](obj as RepositoryScheme) : false; }
            public bool RequiredByProperty(string name, IObject obj) { return Meta.RequiredByProperty.ContainsKey(name) ? Meta.RequiredByProperty[name](obj as RepositoryScheme) : false; }
            public List<SearchPanelMetaItem> SearchPanelMeta { get { return Meta.SearchPanelMeta; } }
            public List<GridMetaItem> GridMeta { get { return Meta.GridMeta; } }
            public List<ActionMetaItem> Actions { get { return Meta.Actions; } }
            public string DetailPanel { get { return "RepositorySchemeDetail"; } }
        ...
        {
            private RepositoryScheme m_obj;
            internal Permissions(RepositoryScheme obj)
            {
                m_obj = obj;
            }
        ...
        {
            public static string spSelect = "spRepositoryScheme_SelectDetail";
            ...
            public static Dictionary<string, Func<RepositoryScheme, bool>> RequiredByField = new Dictionary<string, Func<RepositoryScheme, bool>>();
            public static Dictionary<string, Func<RepositoryScheme, bool>> RequiredByProperty = new Dictionary<string, Func<RepositoryScheme, bool>>();
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(ObjectAccessor.PostInterface<RepositoryScheme>().Post(manager, (RepositoryScheme)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(((RepositoryScheme)c).MarkToDelete() && ObjectAccessor.PostInterface<RepositoryScheme>().Post(manager, (RepositoryScheme)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
