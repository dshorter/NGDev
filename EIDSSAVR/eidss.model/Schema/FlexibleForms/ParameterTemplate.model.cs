...
namespace eidss.model.Schema
{
    ...
    public abstract partial class ParameterTemplate : 
        ...
        protected class field_info
        {
            ...
            internal Action<ParameterTemplate, ParameterTemplate, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m, g) => {
                ...
                if (o.idfsSection != c.idfsSection || o.IsRIRPropChanged(_str_ParentSection, c) || bChangeLookupContent) {
                  m.Add(_str_ParentSection, o.ObjectIdent + _str_ParentSection, o.ObjectIdent2 + _str_ParentSection, o.ObjectIdent3 + _str_ParentSection, "Lookup", o.idfsSection == null ? "" : o.idfsSection.ToString(), o.IsReadOnly(_str_ParentSection), o.IsInvisible(_str_ParentSection), o.IsRequired(_str_ParentSection),
        ...
        public Section ParentSection
        {
            ...
            { 
                ...
                {
                    if (idfsSection != (_ParentSection == null
                            ? new Int64?()
                            : (Int64?)_ParentSection.idfsSection))
                        idfsSection = _ParentSection == null 
                            ? new Int64?()
                            : (Int64?)_ParentSection.idfsSection; 
        ...
        private BvSelectList _getList(string name)
        {
            ...
            switch(name)
            {
                ...
                case _str_ParentSection:
                    return new BvSelectList(ParentSectionLookup, eidss.model.Schema.Section._str_idfsSection, null, ParentSection, _str_idfsSection);
        ...
        {
            get { return new Func<ParameterTemplate, long>(c => c.idfsParameterType.HasValue ? c.idfsParameterType.Value : 0)(this); }
        ...
        public new void RejectChanges()
        {
            ...
            var _prev_idfsSection_ParentSection = idfsSection;
            var _prev_idfsValueDummy_SelectList = idfsValueDummy;
            base.RejectChanges();
        
            if (_prev_idfsSection_ParentSection != idfsSection)
            {
                _ParentSection = _ParentSectionLookup.FirstOrDefault(c => c.idfsSection == idfsSection);
            }
        ...
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, ParameterTemplate c)
        {
    ...
    public void AddHiddenPersonalData(string name, Func<ParameterTemplate, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
            ...
            
        {
            ...
            public delegate void on_action(ParameterTemplate obj);
            ...
            public virtual List<ParameterTemplate> SelectLookupList(DbManagerProxy manager
                , Int64? idfsParameter
            ...
            public List<ParameterTemplate> _SelectList(DbManagerProxy manager
                , Int64? idfsParameter
                , Int64? idfsFormTemplate
            ...
            public virtual List<ParameterTemplate> _SelectListInternal(DbManagerProxy manager
                , Int64? idfsParameter
                , Int64? idfsFormTemplate
                , on_action loading, on_action loaded
                )
            {
                ParameterTemplate _obj = null;
                try
                {
            ...
            {
                ParameterTemplate obj = null;
                try
                {
                    obj = ParameterTemplate.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public void LoadLookup_ParentSection(DbManagerProxy manager, ParameterTemplate obj)
            {
                ...
                if (obj.idfsSection != null && obj.idfsSection != 0)
                {
            ...
            public void LoadLookup_SelectList(DbManagerProxy manager, ParameterTemplate obj)
            {
                ...
                obj.SelectListLookup.AddRange(SelectListAccessor.SelectLookupList(manager
                    ...
                    , new Func<ParameterTemplate, Int64>(c => c.idfsParameterTypeNotNull)(obj)
                            
                    , new Func<ParameterTemplate, Int64>(c => c.idfsFormType)(obj)
            ...
            internal void _LoadLookups(DbManagerProxy manager, ParameterTemplate obj)
            {
