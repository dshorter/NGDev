...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VetAggregateCaseSummary : 
        ...
        protected class field_info
        {
            ...
            internal Action<VetAggregateCaseSummary, VetAggregateCaseSummary, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, VetAggregateCaseSummary c)
        {
    ...
    public void AddHiddenPersonalData(string name, Func<VetAggregateCaseSummary, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            public delegate void on_action(VetAggregateCaseSummary obj);
            ...
            protected virtual VetAggregateCaseSummary _SelectByKeyInternal(DbManagerProxy manager
                , Int64? idfAggrCase
                , on_action loading, on_action loaded
                )
            {
                ...
                VetAggregateCaseSummary obj = null;
                try
                {
                    manager
            ...
            private VetAggregateCaseSummary _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                ...
                try
                {
                    obj = VetAggregateCaseSummary.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public ActResult ReportContextMenu(DbManagerProxy manager, VetAggregateCaseSummary obj, List<object> pars)
            {
                
                return ReportContextMenu(manager, obj
                    );
            }
            public ActResult ReportContextMenu(DbManagerProxy manager, VetAggregateCaseSummary obj
                )
            {
            ...
            internal void _LoadLookups(DbManagerProxy manager, VetAggregateCaseSummary obj)
            {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).ReportContextMenu(manager, (VetAggregateCaseSummary)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    new ActionMetaItem.VisualItem(
                        /*from BvMessages*/"titleVetAggregateCasesSummaryReport",
                        "",
                        /*from BvMessages*/"",
                        /*from BvMessages*/"",
                        "",
