...
namespace eidss.model.Schema
{
    ...
    public abstract partial class TestDiagnosisLookup : 
        EditableObject<TestDiagnosisLookup>
        , IObject
        , IDisposable
        , ILookupUsage
        {
        ...
        protected class field_info
        {
            ...
            internal Func<TestDiagnosisLookup, object> _get_func;
            internal Action<TestDiagnosisLookup, string> _set_func;
            internal Action<TestDiagnosisLookup, TestDiagnosisLookup, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        internal CompareModel _compare(IObject o, CompareModel ret)
        {
            ...
            TestDiagnosisLookup obj = (TestDiagnosisLookup)o;
        ...
        internal string m_ObjectName = "TestDiagnosisLookup";
        ...
        {
            var ret = base.Clone() as TestDiagnosisLookup;
            ret.bIsClone = true;
            ret.Cloned();
        ...
        public TestDiagnosisLookup CloneWithSetup()
        {
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                return CloneWithSetup(manager) as TestDiagnosisLookup;
            }
        }
        #endregion
        ...
        private bool IsRIRPropChanged(string fld, TestDiagnosisLookup c)
        {
            return IsReadOnly(fld) != c.IsReadOnly(fld) || IsInvisible(fld) != c.IsInvisible(fld) || IsRequired(fld) != c._isRequired(m_isRequired, fld);
        }
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, TestDiagnosisLookup c)
        {
        ...
        {
            return new Func<TestDiagnosisLookup, string>(c => c.name)(this);
        }
        

        public TestDiagnosisLookup()
        {
        ...
        {
            PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(TestDiagnosisLookup_PropertyChanged);
        }
        public void _RevokeMainHandler()
        {
            PropertyChanged -= new System.ComponentModel.PropertyChangedEventHandler(TestDiagnosisLookup_PropertyChanged);
        }
        private void TestDiagnosisLookup_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            (sender as TestDiagnosisLookup).Changed(e.PropertyName);
        ...
        internal Dictionary<string, Func<TestDiagnosisLookup, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<TestDiagnosisLookup, bool>> isRequiredDict, string name)
        {
        ...
        public void AddRequired(string name, Func<TestDiagnosisLookup, bool> func)
        {
            if (m_isRequired == null) 
                m_isRequired = new Dictionary<string, Func<TestDiagnosisLookup, bool>>();
            if (!m_isRequired.ContainsKey(name))
                m_isRequired.Add(name, func);
        }
    
    internal Dictionary<string, Func<TestDiagnosisLookup, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<TestDiagnosisLookup, bool> func)
    {
      if (m_isHiddenPersonalData == null)
        m_isHiddenPersonalData = new Dictionary<string, Func<TestDiagnosisLookup, bool>>();
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        : DataAccessor<TestDiagnosisLookup>
            , IObjectAccessor
            , IObjectMeta
            , IObjectValidator
            
            , IObjectCreator
            , IObjectCreator<TestDiagnosisLookup>
            
        {
            ...
            public delegate void on_action(TestDiagnosisLookup obj);
            ...
            public virtual List<TestDiagnosisLookup> SelectLookupList(DbManagerProxy manager
                , Int64? idfMaterial
                , Int64? idfCase
                , Int64? idfCaseType
                )
            ...
            public virtual List<TestDiagnosisLookup> SelectList(DbManagerProxy manager
                , Int64? idfMaterial
                , Int64? idfCase
                , Int64? idfCaseType
                )
            {
                return _SelectList(manager
                    ...
                    , idfCase
                    , idfCaseType
                    , delegate(TestDiagnosisLookup obj)
                        {
                        }
                    , delegate(TestDiagnosisLookup obj)
                        {
            ...
            public List<TestDiagnosisLookup> _SelectList(DbManagerProxy manager
                , Int64? idfMaterial
                , Int64? idfCase
                , Int64? idfCaseType
            ...
            internal void _SetupLoad(DbManagerProxy manager, TestDiagnosisLookup obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            internal void _SetPermitions(IObjectPermissions permissions, TestDiagnosisLookup obj)
            {
                if (obj != null)
                {
            ...
            private TestDiagnosisLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                TestDiagnosisLookup obj = null;
                try
                {
                    obj = TestDiagnosisLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public TestDiagnosisLookup CreateNewT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public TestDiagnosisLookup CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public TestDiagnosisLookup CreateWithParamsT(DbManagerProxy manager, IObject Parent, List<object> pars)
            {
            ...
            private void _SetupChildHandlers(TestDiagnosisLookup obj, object newobj)
            {
                
            }
            
            private void _SetupHandlers(TestDiagnosisLookup obj)
            {
                
            }
    

            internal void _LoadLookups(DbManagerProxy manager, TestDiagnosisLookup obj)
            {
            ...
            protected ValidationModelException ChainsValidate(TestDiagnosisLookup obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(TestDiagnosisLookup obj, bool bRethrowException)
            {
            ...
            {
                return Validate(manager, obj as TestDiagnosisLookup, bPostValidation, bChangeValidation, bDeepValidation, bRethrowException);
            }
            public bool Validate(DbManagerProxy manager, TestDiagnosisLookup obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
            ...
            private void _SetupRequired(TestDiagnosisLookup obj)
            {
            
            }
    
    private void _SetupPersonalDataRestrictions(TestDiagnosisLookup obj)
    {
            ...
            public bool RequiredByField(string name, IObject obj) { return Meta.RequiredByField.ContainsKey(name) ? Meta.RequiredByField[name](obj as TestDiagnosisLookup) : false; }
            public bool RequiredByProperty(string name, IObject obj) { return Meta.RequiredByProperty.ContainsKey(name) ? Meta.RequiredByProperty[name](obj as TestDiagnosisLookup) : false; }
            public List<SearchPanelMetaItem> SearchPanelMeta { get { return Meta.SearchPanelMeta; } }
            public List<GridMetaItem> GridMeta { get { return Meta.GridMeta; } }
            public List<ActionMetaItem> Actions { get { return Meta.Actions; } }
            public string DetailPanel { get { return "TestDiagnosisLookupDetail"; } }
        ...
        {
            public static string spSelect = "spLabTestEditable_GetSampleDiagnosis";
            ...
            public static Dictionary<string, Func<TestDiagnosisLookup, bool>> RequiredByField = new Dictionary<string, Func<TestDiagnosisLookup, bool>>();
            public static Dictionary<string, Func<TestDiagnosisLookup, bool>> RequiredByProperty = new Dictionary<string, Func<TestDiagnosisLookup, bool>>();
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(ObjectAccessor.PostInterface<TestDiagnosisLookup>().Post(manager, (TestDiagnosisLookup)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(((TestDiagnosisLookup)c).MarkToDelete() && ObjectAccessor.PostInterface<TestDiagnosisLookup>().Post(manager, (TestDiagnosisLookup)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
