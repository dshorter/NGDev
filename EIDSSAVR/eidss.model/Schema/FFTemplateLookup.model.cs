...
namespace eidss.model.Schema
{
    ...
    public abstract partial class FFTemplateLookup : 
        EditableObject<FFTemplateLookup>
        , IObject
        , IDisposable
        , ILookupUsage
        {
        ...
        protected class field_info
        {
            ...
            internal Func<FFTemplateLookup, object> _get_func;
            internal Action<FFTemplateLookup, string> _set_func;
            internal Action<FFTemplateLookup, FFTemplateLookup, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        internal CompareModel _compare(IObject o, CompareModel ret)
        {
            ...
            FFTemplateLookup obj = (FFTemplateLookup)o;
        ...
        internal string m_ObjectName = "FFTemplateLookup";
        ...
        {
            var ret = base.Clone() as FFTemplateLookup;
            ret.bIsClone = true;
            ret.Cloned();
        ...
        public FFTemplateLookup CloneWithSetup()
        {
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                return CloneWithSetup(manager) as FFTemplateLookup;
            }
        }
        #endregion
        ...
        private bool IsRIRPropChanged(string fld, FFTemplateLookup c)
        {
            return IsReadOnly(fld) != c.IsReadOnly(fld) || IsInvisible(fld) != c.IsInvisible(fld) || IsRequired(fld) != c._isRequired(m_isRequired, fld);
        }
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, FFTemplateLookup c)
        {
        ...
        {
            return new Func<FFTemplateLookup, string>(c => c.NationalName)(this);
        }
        

        public FFTemplateLookup()
        {
        ...
        {
            PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(FFTemplateLookup_PropertyChanged);
        }
        ...
        internal Dictionary<string, Func<FFTemplateLookup, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<FFTemplateLookup, bool>> isRequiredDict, string name)
        {
        ...
        public void AddRequired(string name, Func<FFTemplateLookup, bool> func)
        {
            if (m_isRequired == null) 
                m_isRequired = new Dictionary<string, Func<FFTemplateLookup, bool>>();
            if (!m_isRequired.ContainsKey(name))
                m_isRequired.Add(name, func);
        }
    
    internal Dictionary<string, Func<FFTemplateLookup, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<FFTemplateLookup, bool> func)
    {
      if (m_isHiddenPersonalData == null)
        m_isHiddenPersonalData = new Dictionary<string, Func<FFTemplateLookup, bool>>();
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        : DataAccessor<FFTemplateLookup>
            , IObjectAccessor
            , IObjectMeta
            , IObjectValidator
            
            , IObjectCreator
            , IObjectCreator<FFTemplateLookup>
            
        {
            ...
            public delegate void on_action(FFTemplateLookup obj);
            ...
            public virtual List<FFTemplateLookup> SelectLookupList(DbManagerProxy manager
            ...
            public virtual List<FFTemplateLookup> SelectList(DbManagerProxy manager
                , Int64? idfsFormTemplate
                , Int64? idfsFormType
                )
            {
            ...
            internal void _SetupLoad(DbManagerProxy manager, FFTemplateLookup obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            internal void _SetPermitions(IObjectPermissions permissions, FFTemplateLookup obj)
            {
                if (obj != null)
                {
            ...
            public FFTemplateLookup CreateNewT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public FFTemplateLookup CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public FFTemplateLookup CreateWithParamsT(DbManagerProxy manager, IObject Parent, List<object> pars)
            {
            ...
            private void _SetupChildHandlers(FFTemplateLookup obj, object newobj)
            {
                
            }
            
            private void _SetupHandlers(FFTemplateLookup obj)
            {
                
            }
    

            internal void _LoadLookups(DbManagerProxy manager, FFTemplateLookup obj)
            {
            ...
            protected ValidationModelException ChainsValidate(FFTemplateLookup obj)
            {
            ...
            {
                return Validate(manager, obj as FFTemplateLookup, bPostValidation, bChangeValidation, bDeepValidation, bRethrowException);
            }
            public bool Validate(DbManagerProxy manager, FFTemplateLookup obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
            ...
            private void _SetupRequired(FFTemplateLookup obj)
            {
            
            }
    
    private void _SetupPersonalDataRestrictions(FFTemplateLookup obj)
    {
            ...
            public bool RequiredByField(string name, IObject obj) { return Meta.RequiredByField.ContainsKey(name) ? Meta.RequiredByField[name](obj as FFTemplateLookup) : false; }
            public bool RequiredByProperty(string name, IObject obj) { return Meta.RequiredByProperty.ContainsKey(name) ? Meta.RequiredByProperty[name](obj as FFTemplateLookup) : false; }
            public List<SearchPanelMetaItem> SearchPanelMeta { get { return Meta.SearchPanelMeta; } }
            public List<GridMetaItem> GridMeta { get { return Meta.GridMeta; } }
            public List<ActionMetaItem> Actions { get { return Meta.Actions; } }
            public string DetailPanel { get { return "FFTemplateLookupDetail"; } }
        ...
        public static class Meta
        {
            ...
            public static Dictionary<string, Func<FFTemplateLookup, bool>> RequiredByField = new Dictionary<string, Func<FFTemplateLookup, bool>>();
            public static Dictionary<string, Func<FFTemplateLookup, bool>> RequiredByProperty = new Dictionary<string, Func<FFTemplateLookup, bool>>();
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(ObjectAccessor.PostInterface<FFTemplateLookup>().Post(manager, (FFTemplateLookup)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(((FFTemplateLookup)c).MarkToDelete() && ObjectAccessor.PostInterface<FFTemplateLookup>().Post(manager, (FFTemplateLookup)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
