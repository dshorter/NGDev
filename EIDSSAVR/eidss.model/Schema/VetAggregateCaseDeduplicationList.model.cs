...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VetAggregateCaseDeduplicationListItem : 
        EditableObject<VetAggregateCaseDeduplicationListItem>
        , IObject
        , IDisposable
        , ILookupUsage
        {
        ...
        protected class field_info
        {
            ...
            internal Func<VetAggregateCaseDeduplicationListItem, object> _get_func;
            internal Action<VetAggregateCaseDeduplicationListItem, string> _set_func;
            internal Action<VetAggregateCaseDeduplicationListItem, VetAggregateCaseDeduplicationListItem, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        internal CompareModel _compare(IObject o, CompareModel ret)
        {
            ...
            VetAggregateCaseDeduplicationListItem obj = (VetAggregateCaseDeduplicationListItem)o;
        ...
        internal string m_ObjectName = "VetAggregateCaseDeduplicationListItem";
        ...
        {
            var ret = base.Clone() as VetAggregateCaseDeduplicationListItem;
            ret.bIsClone = true;
            ret.Cloned();
        ...
        public VetAggregateCaseDeduplicationListItem CloneWithSetup()
        {
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                return CloneWithSetup(manager) as VetAggregateCaseDeduplicationListItem;
            }
        }
        #endregion
        ...
        private bool IsRIRPropChanged(string fld, VetAggregateCaseDeduplicationListItem c)
        {
            return IsReadOnly(fld) != c.IsReadOnly(fld) || IsInvisible(fld) != c.IsInvisible(fld) || IsRequired(fld) != c._isRequired(m_isRequired, fld);
        }
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, VetAggregateCaseDeduplicationListItem c)
        {
        ...
        public VetAggregateCaseDeduplicationListItem()
        {
        ...
        {
            PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(VetAggregateCaseDeduplicationListItem_PropertyChanged);
        }
        public void _RevokeMainHandler()
        {
            PropertyChanged -= new System.ComponentModel.PropertyChangedEventHandler(VetAggregateCaseDeduplicationListItem_PropertyChanged);
        }
        private void VetAggregateCaseDeduplicationListItem_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            (sender as VetAggregateCaseDeduplicationListItem).Changed(e.PropertyName);
        ...
        {
            VetAggregateCaseDeduplicationListItem obj = this;
        ...
        private bool _isReadOnly(string name)
        {
            ...
            return ReadOnly || new Func<VetAggregateCaseDeduplicationListItem, bool>(c => false)(this);
        ...
        internal Dictionary<string, Func<VetAggregateCaseDeduplicationListItem, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<VetAggregateCaseDeduplicationListItem, bool>> isRequiredDict, string name)
        {
        ...
        public void AddRequired(string name, Func<VetAggregateCaseDeduplicationListItem, bool> func)
        {
            if (m_isRequired == null) 
                m_isRequired = new Dictionary<string, Func<VetAggregateCaseDeduplicationListItem, bool>>();
            if (!m_isRequired.ContainsKey(name))
                m_isRequired.Add(name, func);
        }
    
    internal Dictionary<string, Func<VetAggregateCaseDeduplicationListItem, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<VetAggregateCaseDeduplicationListItem, bool> func)
    {
      if (m_isHiddenPersonalData == null)
        m_isHiddenPersonalData = new Dictionary<string, Func<VetAggregateCaseDeduplicationListItem, bool>>();
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        ~VetAggregateCaseDeduplicationListItem()
        {
            Dispose();
        }
        public void Dispose()
        ...
        public class VetAggregateCaseDeduplicationListItemGridModel : IGridModelItem
        {
        ...
        public partial class VetAggregateCaseDeduplicationListItemGridModelList : List<VetAggregateCaseDeduplicationListItemGridModel>, IGridModelList, IGridModelListLoad
        {
            ...
            public VetAggregateCaseDeduplicationListItemGridModelList()
            {
            }
            public void Load(long key, IEnumerable items, string errMes)
            {
                LoadGridModelList(key, items as IEnumerable<VetAggregateCaseDeduplicationListItem>, errMes);
            }
            public VetAggregateCaseDeduplicationListItemGridModelList(long key, IEnumerable items, string errMes)
            {
                LoadGridModelList(key, items as IEnumerable<VetAggregateCaseDeduplicationListItem>, errMes);
            }
            public VetAggregateCaseDeduplicationListItemGridModelList(long key, IEnumerable<VetAggregateCaseDeduplicationListItem> items)
            {
                LoadGridModelList(key, items, null);
            }
            public VetAggregateCaseDeduplicationListItemGridModelList(long key)
            {
                LoadGridModelList(key, new List<VetAggregateCaseDeduplicationListItem>(), null);
            }
            partial void filter(List<VetAggregateCaseDeduplicationListItem> items);
            private void LoadGridModelList(long key, IEnumerable<VetAggregateCaseDeduplicationListItem> items, string errMes)
            {
                ListKey = key;
                ...
                VetAggregateCaseDeduplicationListItem.Meta.Actions.ForEach(a => Actions.Add("@" + a.Name, a));
                var list = new List<VetAggregateCaseDeduplicationListItem>(items);
                filter(list);
                AddRange(list.Where(c => !c.IsMarkedToDelete).Select(c => new VetAggregateCaseDeduplicationListItemGridModel()
                {
        ...
        : DataAccessor<VetAggregateCaseDeduplicationListItem>
            , IObjectAccessor
            , IObjectMeta
            , IObjectValidator
            ...
            , IObjectCreator
            , IObjectCreator<VetAggregateCaseDeduplicationListItem>
            
            , IObjectSelectList
            , IObjectSelectList<VetAggregateCaseDeduplicationListItem>
                    ...
                    
        {
            ...
            public delegate void on_action(VetAggregateCaseDeduplicationListItem obj);
            ...
            public virtual List<VetAggregateCaseDeduplicationListItem> SelectListT(DbManagerProxy manager
            ...
            protected virtual List<VetAggregateCaseDeduplicationListItem> _SelectList(DbManagerProxy manager
                ...
                )
            {
                ...
                sql.Append(@"top ");
                sql.Append(maxtop);
                sql.Append(@" dbo.fn_VetAggregateCaseDeduplication_SelectList.* from dbo.fn_VetAggregateCaseDeduplication_SelectList(@LangID
                    ) ");
                ...
                {
                    sql.Append(@" and exists (select * from  tflAggrCaseFiltered f inner join tflSiteToSiteGroup on tflSiteToSiteGroup.idfSiteGroup = f.idfSiteGroup and tflSiteToSiteGroup.idfsSite = " + EidssSiteContext.Instance.SiteID.ToString() + " where f.idfAggrCase = fn_VetAggregateCaseDeduplication_SelectList.idfAggrCase)");
                }
                ...
                if (filters.Contains("idfAggrCase"))
                {
                    ...
                    for (int i = 0; i < filters.Count("idfAggrCase"); i++)
                    {
                        ...
                        if (filters.Operation("idfAggrCase", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateCaseDeduplication_SelectList.idfAggrCase,0) {0} @idfAggrCase_{1} = @idfAggrCase_{1})", filters.Operation("idfAggrCase", i), i);
                        else
                          sql.AppendFormat("isnull(fn_VetAggregateCaseDeduplication_SelectList.idfAggrCase,0) {0} @idfAggrCase_{1}", filters.Operation("idfAggrCase", i), i);
                ...
                if (filters.Contains("intDuplicateGroup"))
                {
                    ...
                    for (int i = 0; i < filters.Count("intDuplicateGroup"); i++)
                    {
                        ...
                        if (filters.Operation("intDuplicateGroup", i) == "&")
                          sql.AppendFormat("(isnull(fn_VetAggregateCaseDeduplication_SelectList.intDuplicateGroup,0) {0} @intDuplicateGroup_{1} = @intDuplicateGroup_{1})", filters.Operation("intDuplicateGroup", i), i);
                        else
                          sql.AppendFormat("isnull(fn_VetAggregateCaseDeduplication_SelectList.intDuplicateGroup,0) {0} @intDuplicateGroup_{1}", filters.Operation("intDuplicateGroup", i), i);
                ...
                if (filters.Contains("strCaseID"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strCaseID"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_VetAggregateCaseDeduplication_SelectList.strCaseID {0} @strCaseID_{1}", filters.Operation("strCaseID", i), i);
                ...
                if (filters.Contains("datStartDate"))
                {
                    ...
                    for (int i = 0; i < filters.Count("datStartDate"); i++)
                    {
                        ...
                        sql.AppendFormat("CONVERT(NVARCHAR(8), fn_VetAggregateCaseDeduplication_SelectList.datStartDate, 112) {0} CONVERT(NVARCHAR(8), @datStartDate_{1}, 112)", filters.Operation("datStartDate", i), i);
                ...
                if (filters.Contains("strPeriodName"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strPeriodName"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_VetAggregateCaseDeduplication_SelectList.strPeriodName {0} @strPeriodName_{1}", filters.Operation("strPeriodName", i), i);
                ...
                if (filters.Contains("strRegion"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strRegion"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_VetAggregateCaseDeduplication_SelectList.strRegion {0} @strRegion_{1}", filters.Operation("strRegion", i), i);
                ...
                if (filters.Contains("strRayon"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strRayon"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_VetAggregateCaseDeduplication_SelectList.strRayon {0} @strRayon_{1}", filters.Operation("strRayon", i), i);
                ...
                if (filters.Contains("strSettlement"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strSettlement"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_VetAggregateCaseDeduplication_SelectList.strSettlement {0} @strSettlement_{1}", filters.Operation("strSettlement", i), i);
                ...
                if (filters.Contains("strInstitutionName"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strInstitutionName"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_VetAggregateCaseDeduplication_SelectList.strInstitutionName {0} @strInstitutionName_{1}", filters.Operation("strInstitutionName", i), i);
                ...
                if (filters.Contains("datEnteredByDate"))
                {
                    ...
                    for (int i = 0; i < filters.Count("datEnteredByDate"); i++)
                    {
                        ...
                        sql.AppendFormat("CONVERT(NVARCHAR(8), fn_VetAggregateCaseDeduplication_SelectList.datEnteredByDate, 112) {0} CONVERT(NVARCHAR(8), @datEnteredByDate_{1}, 112)", filters.Operation("datEnteredByDate", i), i);
                ...
                if (filters.Contains("strMatrixName"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strMatrixName"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_VetAggregateCaseDeduplication_SelectList.strMatrixName {0} @strMatrixName_{1}", filters.Operation("strMatrixName", i), i);
                ...
                if (filters.Contains("strTemplateName"))
                {
                    ...
                    for (int i = 0; i < filters.Count("strTemplateName"); i++)
                    {
                        ...
                        sql.AppendFormat("fn_VetAggregateCaseDeduplication_SelectList.strTemplateName {0} @strTemplateName_{1}", filters.Operation("strTemplateName", i), i);
                ...
                try
                {
                    ...
                    List<VetAggregateCaseDeduplicationListItem> objs = manager.ExecuteList<VetAggregateCaseDeduplicationListItem>();
            ...
            partial void ListSelected(DbManagerProxy manager, List<VetAggregateCaseDeduplicationListItem> objs);
            ...
            internal void _SetupLoad(DbManagerProxy manager, VetAggregateCaseDeduplicationListItem obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            internal void _SetPermitions(IObjectPermissions permissions, VetAggregateCaseDeduplicationListItem obj)
            {
                if (obj != null)
                {
            ...
            private VetAggregateCaseDeduplicationListItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                VetAggregateCaseDeduplicationListItem obj = null;
                try
                {
                    obj = VetAggregateCaseDeduplicationListItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public VetAggregateCaseDeduplicationListItem CreateNewT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public VetAggregateCaseDeduplicationListItem CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public VetAggregateCaseDeduplicationListItem CreateWithParamsT(DbManagerProxy manager, IObject Parent, List<object> pars)
            {
            ...
            public ActResult FindDuplicates(DbManagerProxy manager, VetAggregateCaseDeduplicationListItem obj, List<object> pars)
            {
                
                return FindDuplicates(manager, obj
                    );
            }
            public ActResult FindDuplicates(DbManagerProxy manager, VetAggregateCaseDeduplicationListItem obj
                )
            {
                
                if (obj != null && !obj.GetPermissions().CanExecute("FindDuplicates"))
                    throw new PermissionException("AccessToVetAggregateCase", "FindDuplicates");
            ...
            public ActResult ActionEditHumanAggregateCase(DbManagerProxy manager, VetAggregateCaseDeduplicationListItem obj, List<object> pars)
            {
                
                return ActionEditHumanAggregateCase(manager, obj
                    );
            }
            public ActResult ActionEditHumanAggregateCase(DbManagerProxy manager, VetAggregateCaseDeduplicationListItem obj
                )
            {
                
                if (obj != null && !obj.GetPermissions().CanExecute("ActionEditHumanAggregateCase"))
                    throw new PermissionException("AccessToVetAggregateCase", "ActionEditHumanAggregateCase");
            ...
            private void _SetupChildHandlers(VetAggregateCaseDeduplicationListItem obj, object newobj)
            {
                
            }
            
            private void _SetupHandlers(VetAggregateCaseDeduplicationListItem obj)
            {
                
            }
    

            internal void _LoadLookups(DbManagerProxy manager, VetAggregateCaseDeduplicationListItem obj)
            {
            ...
            public bool Post(DbManagerProxy manager, IObject obj, bool bChildObject = false)
            {
                ...
                for (int iAttemptNumber = 0; iAttemptNumber < iDeadlockAttemptsCount; iAttemptNumber++)
                {
                    ...
                    try
                    {
                        VetAggregateCaseDeduplicationListItem bo = obj as VetAggregateCaseDeduplicationListItem;
                        ...
                        bSuccess = _PostNonTransaction(manager, obj as VetAggregateCaseDeduplicationListItem, bChildObject);
                        if (bTransactionStarted)
                        {
                            if (bSuccess)
                            {
            ...
            private bool _PostNonTransaction(DbManagerProxy manager, VetAggregateCaseDeduplicationListItem obj, bool bChildObject) 
            { 
            ...
            public bool ValidateCanDelete(VetAggregateCaseDeduplicationListItem obj)
            {
                using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
                {
            ...
            public bool ValidateCanDelete(DbManagerProxy manager, VetAggregateCaseDeduplicationListItem obj)
            {
            ...
            protected ValidationModelException ChainsValidate(VetAggregateCaseDeduplicationListItem obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(VetAggregateCaseDeduplicationListItem obj, bool bRethrowException)
            {
            ...
            {
                return Validate(manager, obj as VetAggregateCaseDeduplicationListItem, bPostValidation, bChangeValidation, bDeepValidation, bRethrowException);
            }
            public bool Validate(DbManagerProxy manager, VetAggregateCaseDeduplicationListItem obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
            ...
            private void _SetupRequired(VetAggregateCaseDeduplicationListItem obj)
            {
            
            }
    
    private void _SetupPersonalDataRestrictions(VetAggregateCaseDeduplicationListItem obj)
    {
            ...
            public bool RequiredByField(string name, IObject obj) { return Meta.RequiredByField.ContainsKey(name) ? Meta.RequiredByField[name](obj as VetAggregateCaseDeduplicationListItem) : false; }
            public bool RequiredByProperty(string name, IObject obj) { return Meta.RequiredByProperty.ContainsKey(name) ? Meta.RequiredByProperty[name](obj as VetAggregateCaseDeduplicationListItem) : false; }
            public List<SearchPanelMetaItem> SearchPanelMeta { get { return Meta.SearchPanelMeta; } }
            public List<GridMetaItem> GridMeta { get { return Meta.GridMeta; } }
            public List<ActionMetaItem> Actions { get { return Meta.Actions; } }
            public string DetailPanel { get { return "VetAggregateCaseDeduplicationListItemDetail"; } }
            public string HelpIdWin { get { return "VAC_deduplication"; } }
            public string HelpIdWeb { get { return "VAC_deduplication"; } }
        ...
        {
            private VetAggregateCaseDeduplicationListItem m_obj;
            internal Permissions(VetAggregateCaseDeduplicationListItem obj)
            {
                m_obj = obj;
            }
        ...
        {
            public static string spSelect = "fn_VetAggregateCaseDeduplication_SelectList";
            ...
            public static Dictionary<string, Func<VetAggregateCaseDeduplicationListItem, bool>> RequiredByField = new Dictionary<string, Func<VetAggregateCaseDeduplicationListItem, bool>>();
            public static Dictionary<string, Func<VetAggregateCaseDeduplicationListItem, bool>> RequiredByProperty = new Dictionary<string, Func<VetAggregateCaseDeduplicationListItem, bool>>();
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).FindDuplicates(manager, (VetAggregateCaseDeduplicationListItem)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).ActionEditHumanAggregateCase(manager, (VetAggregateCaseDeduplicationListItem)c, pars),
                    ...
                    (manager, c, pars) => 
                        {
                            if (c == null)
                            {
                                c = ObjectAccessor.CreatorInterface<VetAggregateCaseDeduplicationListItem>().CreateWithParams(manager, null, pars);
                                ((VetAggregateCaseDeduplicationListItem)c).idfAggrCase = (long)pars[0];
                                ((VetAggregateCaseDeduplicationListItem)c).m_IsNew = false;
                            }
                            return new ActResult(((VetAggregateCaseDeduplicationListItem)c).MarkToDelete() && ObjectAccessor.PostInterface<VetAggregateCaseDeduplicationListItem>().Post(manager, (VetAggregateCaseDeduplicationListItem)c), c);
                        }
                                            ,
                    null,
                    new ActionMetaItem.VisualItem(
