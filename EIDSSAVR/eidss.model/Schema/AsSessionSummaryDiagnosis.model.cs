...
namespace eidss.model.Schema
{
    ...
    public abstract partial class AsSessionSummaryDiagnosis : 
        ...
        protected class field_info
        {
            ...
            internal Action<AsSessionSummaryDiagnosis, AsSessionSummaryDiagnosis, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, AsSessionSummaryDiagnosis c)
        {
        ...
        internal Dictionary<string, Func<AsSessionSummaryDiagnosis, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<AsSessionSummaryDiagnosis, bool>> isRequiredDict, string name)
        {
    ...
    internal Dictionary<string, Func<AsSessionSummaryDiagnosis, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<AsSessionSummaryDiagnosis, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        : DataAccessor<AsSessionSummaryDiagnosis>
            ...
            , IObjectCreator
            , IObjectCreator<AsSessionSummaryDiagnosis>
                ...
                
        {
            ...
            public delegate void on_action(AsSessionSummaryDiagnosis obj);
            ...
            public List<AsSessionSummaryDiagnosis> _SelectList(DbManagerProxy manager
                , Int64? idfMonitoringSessionSummary
            ...
            public virtual List<AsSessionSummaryDiagnosis> _SelectListInternal(DbManagerProxy manager
                , Int64? idfMonitoringSessionSummary
                , on_action loading, on_action loaded
                )
            {
                AsSessionSummaryDiagnosis _obj = null;
                try
                {
                    ...
                    manager
                        .SetSpCommand("spASSessionSummaryDiagnosisForModel_SelectDetail"
            ...
            internal void _SetupLoad(DbManagerProxy manager, AsSessionSummaryDiagnosis obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            private AsSessionSummaryDiagnosis _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                AsSessionSummaryDiagnosis obj = null;
                try
                {
                    obj = AsSessionSummaryDiagnosis.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public AsSessionSummaryDiagnosis CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            internal void _LoadLookups(DbManagerProxy manager, AsSessionSummaryDiagnosis obj)
            {
            ...
            protected ValidationModelException ChainsValidate(AsSessionSummaryDiagnosis obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(AsSessionSummaryDiagnosis obj, bool bRethrowException)
            {
    ...
    private void _SetupPersonalDataRestrictions(AsSessionSummaryDiagnosis obj)
    {
        ...
        {
            public static string spSelect = "spASSessionSummaryDiagnosisForModel_SelectDetail";
