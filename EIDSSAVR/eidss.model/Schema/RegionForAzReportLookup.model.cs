...
namespace eidss.model.Schema
{
    ...
    public abstract partial class RegionForAzReportLookup : 
        EditableObject<RegionForAzReportLookup>
        , IObject
        , IDisposable
        , ILookupUsage
        {
        ...
        protected class field_info
        {
            ...
            internal Func<RegionForAzReportLookup, object> _get_func;
            internal Action<RegionForAzReportLookup, string> _set_func;
            internal Action<RegionForAzReportLookup, RegionForAzReportLookup, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        internal CompareModel _compare(IObject o, CompareModel ret)
        {
            ...
            RegionForAzReportLookup obj = (RegionForAzReportLookup)o;
        ...
        internal string m_ObjectName = "RegionForAzReportLookup";
        ...
        {
            var ret = base.Clone() as RegionForAzReportLookup;
            ret.bIsClone = true;
            ret.Cloned();
        ...
        public RegionForAzReportLookup CloneWithSetup()
        {
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                return CloneWithSetup(manager) as RegionForAzReportLookup;
            }
        }
        #endregion
        ...
        private bool IsRIRPropChanged(string fld, RegionForAzReportLookup c)
        {
            return IsReadOnly(fld) != c.IsReadOnly(fld) || IsInvisible(fld) != c.IsInvisible(fld) || IsRequired(fld) != c._isRequired(m_isRequired, fld);
        }
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, RegionForAzReportLookup c)
        {
        ...
        {
            return new Func<RegionForAzReportLookup, string>(c => c.strRegionName)(this);
        }
        

        public RegionForAzReportLookup()
        {
        ...
        {
            PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(RegionForAzReportLookup_PropertyChanged);
        }
        public void _RevokeMainHandler()
        {
            PropertyChanged -= new System.ComponentModel.PropertyChangedEventHandler(RegionForAzReportLookup_PropertyChanged);
        }
        private void RegionForAzReportLookup_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            (sender as RegionForAzReportLookup).Changed(e.PropertyName);
        ...
        {
            RegionForAzReportLookup obj = this;
        ...
        internal Dictionary<string, Func<RegionForAzReportLookup, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<RegionForAzReportLookup, bool>> isRequiredDict, string name)
        {
        ...
        public void AddRequired(string name, Func<RegionForAzReportLookup, bool> func)
        {
            if (m_isRequired == null) 
                m_isRequired = new Dictionary<string, Func<RegionForAzReportLookup, bool>>();
            if (!m_isRequired.ContainsKey(name))
                m_isRequired.Add(name, func);
        }
    
    internal Dictionary<string, Func<RegionForAzReportLookup, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<RegionForAzReportLookup, bool> func)
    {
      if (m_isHiddenPersonalData == null)
        m_isHiddenPersonalData = new Dictionary<string, Func<RegionForAzReportLookup, bool>>();
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        : DataAccessor<RegionForAzReportLookup>
            , IObjectAccessor
            , IObjectMeta
            , IObjectValidator
            
            , IObjectCreator
            , IObjectCreator<RegionForAzReportLookup>
            
        {
            ...
            public delegate void on_action(RegionForAzReportLookup obj);
            ...
            public virtual List<RegionForAzReportLookup> SelectLookupList(DbManagerProxy manager
                , Int64? CountryID
                , Int64? ID
                )
            {
            ...
            public virtual List<RegionForAzReportLookup> SelectList(DbManagerProxy manager
                , Int64? CountryID
                , Int64? ID
                )
            {
                return _SelectList(manager
                    , CountryID
                    , ID
                    , delegate(RegionForAzReportLookup obj)
                        {
                        }
                    , delegate(RegionForAzReportLookup obj)
                        {
            ...
            internal void _SetupLoad(DbManagerProxy manager, RegionForAzReportLookup obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            private RegionForAzReportLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                RegionForAzReportLookup obj = null;
                try
                {
                    obj = RegionForAzReportLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public RegionForAzReportLookup CreateNewT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public RegionForAzReportLookup CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public RegionForAzReportLookup CreateWithParamsT(DbManagerProxy manager, IObject Parent, List<object> pars)
            {
            ...
            private void _SetupChildHandlers(RegionForAzReportLookup obj, object newobj)
            {
                
            }
            
            private void _SetupHandlers(RegionForAzReportLookup obj)
            {
                
            }
    

            internal void _LoadLookups(DbManagerProxy manager, RegionForAzReportLookup obj)
            {
            ...
            protected ValidationModelException ChainsValidate(RegionForAzReportLookup obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(RegionForAzReportLookup obj, bool bRethrowException)
            {
            ...
            {
                return Validate(manager, obj as RegionForAzReportLookup, bPostValidation, bChangeValidation, bDeepValidation, bRethrowException);
            }
            public bool Validate(DbManagerProxy manager, RegionForAzReportLookup obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
            ...
            private void _SetupRequired(RegionForAzReportLookup obj)
            {
            
            }
    
    private void _SetupPersonalDataRestrictions(RegionForAzReportLookup obj)
    {
            ...
            public bool RequiredByField(string name, IObject obj) { return Meta.RequiredByField.ContainsKey(name) ? Meta.RequiredByField[name](obj as RegionForAzReportLookup) : false; }
            public bool RequiredByProperty(string name, IObject obj) { return Meta.RequiredByProperty.ContainsKey(name) ? Meta.RequiredByProperty[name](obj as RegionForAzReportLookup) : false; }
            public List<SearchPanelMetaItem> SearchPanelMeta { get { return Meta.SearchPanelMeta; } }
            public List<GridMetaItem> GridMeta { get { return Meta.GridMeta; } }
            public List<ActionMetaItem> Actions { get { return Meta.Actions; } }
            public string DetailPanel { get { return "RegionForAzReportLookupDetail"; } }
        ...
        {
            public static string spSelect = "spRegionAz_SelectLookup";
            ...
            public static Dictionary<string, Func<RegionForAzReportLookup, bool>> RequiredByField = new Dictionary<string, Func<RegionForAzReportLookup, bool>>();
            public static Dictionary<string, Func<RegionForAzReportLookup, bool>> RequiredByProperty = new Dictionary<string, Func<RegionForAzReportLookup, bool>>();
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(ObjectAccessor.PostInterface<RegionForAzReportLookup>().Post(manager, (RegionForAzReportLookup)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(((RegionForAzReportLookup)c).MarkToDelete() && ObjectAccessor.PostInterface<RegionForAzReportLookup>().Post(manager, (RegionForAzReportLookup)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
