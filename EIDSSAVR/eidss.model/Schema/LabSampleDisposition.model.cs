...
namespace eidss.model.Schema
{
    ...
    public abstract partial class LabSampleDisposition : 
        ...
        protected class field_info
        {
            ...
            internal Action<LabSampleDisposition, LabSampleDisposition, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, LabSampleDisposition c)
        {
        ...
        internal Dictionary<string, Func<LabSampleDisposition, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<LabSampleDisposition, bool>> isRequiredDict, string name)
        {
    ...
    internal Dictionary<string, Func<LabSampleDisposition, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<LabSampleDisposition, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        : DataAccessor<LabSampleDisposition>
            ...
            , IObjectCreator
            , IObjectCreator<LabSampleDisposition>
            
            , IObjectSelectDetail
            , IObjectSelectDetail<LabSampleDisposition>
            , IObjectPost
            , IObjectDelete
                    
        {
            ...
            public delegate void on_action(LabSampleDisposition obj);
            ...
            public virtual LabSampleDisposition SelectDetailT(DbManagerProxy manager, object ident, int? HACode = null)
            {
                if (ident == null)
                {
            ...
            protected virtual LabSampleDisposition _SelectByKeyInternal(DbManagerProxy manager
                , Boolean destroy
                , on_action loading, on_action loaded
                )
            {
            ...
            internal void _SetupLoad(DbManagerProxy manager, LabSampleDisposition obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            private LabSampleDisposition _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                LabSampleDisposition obj = null;
                try
                {
                    obj = LabSampleDisposition.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public LabSampleDisposition CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            internal void _LoadLookups(DbManagerProxy manager, LabSampleDisposition obj)
            {
            ...
            protected ValidationModelException ChainsValidate(LabSampleDisposition obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(LabSampleDisposition obj, bool bRethrowException)
            {
