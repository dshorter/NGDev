...
namespace eidss.model.Schema
{
    ...
    public abstract partial class SiteActivationServer : 
        EditableObject<SiteActivationServer>
        , IObject
        , IDisposable
        , ILookupUsage
        {
        ...
        protected class field_info
        {
            ...
            internal Func<SiteActivationServer, object> _get_func;
            internal Action<SiteActivationServer, string> _set_func;
            internal Action<SiteActivationServer, SiteActivationServer, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        internal CompareModel _compare(IObject o, CompareModel ret)
        {
            ...
            SiteActivationServer obj = (SiteActivationServer)o;
        ...
        internal string m_ObjectName = "SiteActivationServer";
        ...
        {
            var ret = base.Clone() as SiteActivationServer;
            ret.bIsClone = true;
            ret.Cloned();
        ...
        public SiteActivationServer CloneWithSetup()
        {
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                return CloneWithSetup(manager) as SiteActivationServer;
            }
        }
        #endregion
        ...
        private bool IsRIRPropChanged(string fld, SiteActivationServer c)
        {
            return IsReadOnly(fld) != c.IsReadOnly(fld) || IsInvisible(fld) != c.IsInvisible(fld) || IsRequired(fld) != c._isRequired(m_isRequired, fld);
        }
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, SiteActivationServer c)
        {
        ...
        {
            PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(SiteActivationServer_PropertyChanged);
        }
        public void _RevokeMainHandler()
        {
            PropertyChanged -= new System.ComponentModel.PropertyChangedEventHandler(SiteActivationServer_PropertyChanged);
        }
        private void SiteActivationServer_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            (sender as SiteActivationServer).Changed(e.PropertyName);
        ...
        internal Dictionary<string, Func<SiteActivationServer, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<SiteActivationServer, bool>> isRequiredDict, string name)
        {
        ...
        public void AddRequired(string name, Func<SiteActivationServer, bool> func)
        {
            if (m_isRequired == null) 
                m_isRequired = new Dictionary<string, Func<SiteActivationServer, bool>>();
            if (!m_isRequired.ContainsKey(name))
                m_isRequired.Add(name, func);
        }
    
    internal Dictionary<string, Func<SiteActivationServer, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<SiteActivationServer, bool> func)
    {
      if (m_isHiddenPersonalData == null)
        m_isHiddenPersonalData = new Dictionary<string, Func<SiteActivationServer, bool>>();
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        : DataAccessor<SiteActivationServer>
            , IObjectAccessor
            , IObjectMeta
            , IObjectValidator
            
            , IObjectCreator
            , IObjectCreator<SiteActivationServer>
            
            , IObjectSelectDetail
            , IObjectSelectDetail<SiteActivationServer>
            , IObjectPost
            , IObjectDelete
                    
        {
            ...
            public delegate void on_action(SiteActivationServer obj);
            ...
            public virtual SiteActivationServer SelectDetailT(DbManagerProxy manager, object ident, int? HACode = null)
            {
                if (ident == null)
                {
            ...
            public virtual SiteActivationServer SelectByKey(DbManagerProxy manager
                , Int64? SiteID
                )
            {
                return _SelectByKey(manager
            ...
            private SiteActivationServer _SelectByKey(DbManagerProxy manager
                , Int64? SiteID
            ...
            protected virtual SiteActivationServer _SelectByKeyInternal(DbManagerProxy manager
                , Int64? SiteID
                , on_action loading, on_action loaded
                )
            {
                ...
                List<SiteActivationServer> objs = new List<SiteActivationServer>();
                sets[0] = new MapResultSet(typeof(SiteActivationServer), objs);
                SiteActivationServer obj = null;
                try
                {
                    manager
                        .SetSpCommand("spSiteActivationServer_SelectDetail"
                            , manager.Parameter("@SiteID", SiteID)
            ...
            internal void _SetupLoad(DbManagerProxy manager, SiteActivationServer obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            internal void _SetPermitions(IObjectPermissions permissions, SiteActivationServer obj)
            {
                if (obj != null)
                {
            ...
            private SiteActivationServer _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                SiteActivationServer obj = null;
                try
                {
                    obj = SiteActivationServer.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public SiteActivationServer CreateNewT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public SiteActivationServer CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public SiteActivationServer CreateWithParamsT(DbManagerProxy manager, IObject Parent, List<object> pars)
            {
            ...
            private void _SetupChildHandlers(SiteActivationServer obj, object newobj)
            {
                
            }
            
            private void _SetupHandlers(SiteActivationServer obj)
            {
                
            }
    

            internal void _LoadLookups(DbManagerProxy manager, SiteActivationServer obj)
            {
            ...
            protected ValidationModelException ChainsValidate(SiteActivationServer obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(SiteActivationServer obj, bool bRethrowException)
            {
            ...
            {
                return Validate(manager, obj as SiteActivationServer, bPostValidation, bChangeValidation, bDeepValidation, bRethrowException);
            }
            public bool Validate(DbManagerProxy manager, SiteActivationServer obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
            ...
            private void _SetupRequired(SiteActivationServer obj)
            {
            
            }
    
    private void _SetupPersonalDataRestrictions(SiteActivationServer obj)
    {
            ...
            public bool RequiredByField(string name, IObject obj) { return Meta.RequiredByField.ContainsKey(name) ? Meta.RequiredByField[name](obj as SiteActivationServer) : false; }
            public bool RequiredByProperty(string name, IObject obj) { return Meta.RequiredByProperty.ContainsKey(name) ? Meta.RequiredByProperty[name](obj as SiteActivationServer) : false; }
            public List<SearchPanelMetaItem> SearchPanelMeta { get { return Meta.SearchPanelMeta; } }
            public List<GridMetaItem> GridMeta { get { return Meta.GridMeta; } }
            public List<ActionMetaItem> Actions { get { return Meta.Actions; } }
            public string DetailPanel { get { return "SiteActivationServerDetail"; } }
        ...
        {
            public static string spSelect = "spSiteActivationServer_SelectDetail";
            ...
            public static Dictionary<string, Func<SiteActivationServer, bool>> RequiredByField = new Dictionary<string, Func<SiteActivationServer, bool>>();
            public static Dictionary<string, Func<SiteActivationServer, bool>> RequiredByProperty = new Dictionary<string, Func<SiteActivationServer, bool>>();
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(ObjectAccessor.PostInterface<SiteActivationServer>().Post(manager, (SiteActivationServer)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(((SiteActivationServer)c).MarkToDelete() && ObjectAccessor.PostInterface<SiteActivationServer>().Post(manager, (SiteActivationServer)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
