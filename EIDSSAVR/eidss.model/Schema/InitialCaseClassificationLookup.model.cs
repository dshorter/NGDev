...
namespace eidss.model.Schema
{
    ...
    public abstract partial class InitialCaseClassificationLookup : 
        EditableObject<InitialCaseClassificationLookup>
        , IObject
        , IDisposable
        , ILookupUsage
        {
        ...
        protected class field_info
        {
            ...
            internal Func<InitialCaseClassificationLookup, object> _get_func;
            internal Action<InitialCaseClassificationLookup, string> _set_func;
            internal Action<InitialCaseClassificationLookup, InitialCaseClassificationLookup, CompareModel, DbManagerProxy> _compare_func;
        }
        ...
        internal CompareModel _compare(IObject o, CompareModel ret)
        {
            ...
            InitialCaseClassificationLookup obj = (InitialCaseClassificationLookup)o;
        ...
        internal string m_ObjectName = "InitialCaseClassificationLookup";
        ...
        {
            var ret = base.Clone() as InitialCaseClassificationLookup;
            ret.bIsClone = true;
            ret.Cloned();
        ...
        public InitialCaseClassificationLookup CloneWithSetup()
        {
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                return CloneWithSetup(manager) as InitialCaseClassificationLookup;
            }
        }
        #endregion
        ...
        private bool IsRIRPropChanged(string fld, InitialCaseClassificationLookup c)
        {
            return IsReadOnly(fld) != c.IsReadOnly(fld) || IsInvisible(fld) != c.IsInvisible(fld) || IsRequired(fld) != c._isRequired(m_isRequired, fld);
        }
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, InitialCaseClassificationLookup c)
        {
        ...
        {
            return new Func<InitialCaseClassificationLookup, string>(c => c.name)(this);
        }
        

        public InitialCaseClassificationLookup()
        {
        ...
        {
            PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(InitialCaseClassificationLookup_PropertyChanged);
        }
        public void _RevokeMainHandler()
        {
            PropertyChanged -= new System.ComponentModel.PropertyChangedEventHandler(InitialCaseClassificationLookup_PropertyChanged);
        }
        private void InitialCaseClassificationLookup_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            (sender as InitialCaseClassificationLookup).Changed(e.PropertyName);
        ...
        {
            InitialCaseClassificationLookup obj = this;
        ...
        internal Dictionary<string, Func<InitialCaseClassificationLookup, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<InitialCaseClassificationLookup, bool>> isRequiredDict, string name)
        {
        ...
        public void AddRequired(string name, Func<InitialCaseClassificationLookup, bool> func)
        {
            if (m_isRequired == null) 
                m_isRequired = new Dictionary<string, Func<InitialCaseClassificationLookup, bool>>();
            if (!m_isRequired.ContainsKey(name))
                m_isRequired.Add(name, func);
        }
    
    internal Dictionary<string, Func<InitialCaseClassificationLookup, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<InitialCaseClassificationLookup, bool> func)
    {
      if (m_isHiddenPersonalData == null)
        m_isHiddenPersonalData = new Dictionary<string, Func<InitialCaseClassificationLookup, bool>>();
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        ~InitialCaseClassificationLookup()
        {
            Dispose();
        }
        public void Dispose()
        ...
        : DataAccessor<InitialCaseClassificationLookup>
            , IObjectAccessor
            , IObjectMeta
            , IObjectValidator
            
            , IObjectCreator
            , IObjectCreator<InitialCaseClassificationLookup>
            
        {
            ...
            public delegate void on_action(InitialCaseClassificationLookup obj);
            ...
            public virtual List<InitialCaseClassificationLookup> SelectLookupList(DbManagerProxy manager
                )
            {
            ...
            {
                return "InitialCaseClassification";
            }
            
            public virtual List<InitialCaseClassificationLookup> SelectList(DbManagerProxy manager
                )
            {
                return _SelectList(manager
                    , delegate(InitialCaseClassificationLookup obj)
                        {
                        }
                    , delegate(InitialCaseClassificationLookup obj)
                        {
            ...
            public List<InitialCaseClassificationLookup> _SelectList(DbManagerProxy manager
            ...
            public virtual List<InitialCaseClassificationLookup> _SelectListInternal(DbManagerProxy manager
                , on_action loading, on_action loaded
                )
            {
                InitialCaseClassificationLookup _obj = null;
                try
                {
                    MapResultSet[] sets = new MapResultSet[1];
                    List<InitialCaseClassificationLookup> objs = new List<InitialCaseClassificationLookup>();
                    sets[0] = new MapResultSet(typeof(InitialCaseClassificationLookup), objs);
                    
                    manager
                        .SetSpCommand("spInitialCaseClassification_SelectLookup"
            ...
            internal void _SetupLoad(DbManagerProxy manager, InitialCaseClassificationLookup obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            internal void _SetPermitions(IObjectPermissions permissions, InitialCaseClassificationLookup obj)
            {
                if (obj != null)
                {
            ...
            private InitialCaseClassificationLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                InitialCaseClassificationLookup obj = null;
                try
                {
                    obj = InitialCaseClassificationLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public InitialCaseClassificationLookup CreateNewT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public InitialCaseClassificationLookup CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public InitialCaseClassificationLookup CreateWithParamsT(DbManagerProxy manager, IObject Parent, List<object> pars)
            {
            ...
            private void _SetupChildHandlers(InitialCaseClassificationLookup obj, object newobj)
            {
                
            }
            
            private void _SetupHandlers(InitialCaseClassificationLookup obj)
            {
                
            }
    

            internal void _LoadLookups(DbManagerProxy manager, InitialCaseClassificationLookup obj)
            {
            ...
            protected ValidationModelException ChainsValidate(InitialCaseClassificationLookup obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(InitialCaseClassificationLookup obj, bool bRethrowException)
            {
            ...
            {
                return Validate(manager, obj as InitialCaseClassificationLookup, bPostValidation, bChangeValidation, bDeepValidation, bRethrowException);
            }
            public bool Validate(DbManagerProxy manager, InitialCaseClassificationLookup obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
            ...
            private void _SetupRequired(InitialCaseClassificationLookup obj)
            {
            
            }
    
    private void _SetupPersonalDataRestrictions(InitialCaseClassificationLookup obj)
    {
            ...
            public bool RequiredByField(string name, IObject obj) { return Meta.RequiredByField.ContainsKey(name) ? Meta.RequiredByField[name](obj as InitialCaseClassificationLookup) : false; }
            public bool RequiredByProperty(string name, IObject obj) { return Meta.RequiredByProperty.ContainsKey(name) ? Meta.RequiredByProperty[name](obj as InitialCaseClassificationLookup) : false; }
            public List<SearchPanelMetaItem> SearchPanelMeta { get { return Meta.SearchPanelMeta; } }
            public List<GridMetaItem> GridMeta { get { return Meta.GridMeta; } }
            public List<ActionMetaItem> Actions { get { return Meta.Actions; } }
            public string DetailPanel { get { return "InitialCaseClassificationLookupDetail"; } }
        ...
        {
            public static string spSelect = "spInitialCaseClassification_SelectLookup";
            ...
            public static Dictionary<string, Func<InitialCaseClassificationLookup, bool>> RequiredByField = new Dictionary<string, Func<InitialCaseClassificationLookup, bool>>();
            public static Dictionary<string, Func<InitialCaseClassificationLookup, bool>> RequiredByProperty = new Dictionary<string, Func<InitialCaseClassificationLookup, bool>>();
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(ObjectAccessor.PostInterface<InitialCaseClassificationLookup>().Post(manager, (InitialCaseClassificationLookup)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(((InitialCaseClassificationLookup)c).MarkToDelete() && ObjectAccessor.PostInterface<InitialCaseClassificationLookup>().Post(manager, (InitialCaseClassificationLookup)c), c),
                    null,
                    new ActionMetaItem.VisualItem(
