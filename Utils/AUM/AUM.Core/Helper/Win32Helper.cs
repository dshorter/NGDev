...
namespace AUM.Core.Helper
{
    public static class Win32Helper
    {
        ...
        /// <summary>
        /// Получение системных каталогов
        /// </summary>
        /// <param name="directory"></param>
        /// <returns></returns>
        public static string GetDirectoryPath(Win32Directories directory)
        {

            var sbPath = new StringBuilder(260);//MAX_PATH = 260;

            try
            {
                SHGetFolderPath(IntPtr.Zero, (int) directory, IntPtr.Zero, 0, sbPath);
            }
